<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Quality_DefectManager, Mesnac.Quality.WebSite" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_editdefect = function (record) {
            ...
            App.direct.commandcolumn_direct_editdefect(ObjID, DefectName,DefectCode, WorkProcessID, WorkProcessName, Remark, {
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="DefectName" runat="server" Text="病疵名称" DataIndex="DEFECTNAME" Width="360" />
                                <ext:Column ID="DefectCode" runat="server" Text="病疵编号" DataIndex="DEFECTCODE" Width="60" />
