<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FqfFcheckPercent.aspx.cs" Inherits="Plugins_Quality_Fcheck_FqfFcheckPercent" %>
                ...
                <Items>
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                        <Items>
                            ...
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".3" Hidden="true"
                                Padding="5">
                                <Items>
                                    <ext:ComboBox ID="cbxClass" runat="server" FieldLabel="质检班组" LabelAlign="Right" Editable="false"></ext:ComboBox>
                                </Items>
                            </ext:Container>
                        </Items>
                        <Listeners>
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="TYREID" runat="server" Text="成型号" DataIndex="TYREID" Flex="1" />
