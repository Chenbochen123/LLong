<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FqfFcheckInfo.aspx.cs" Inherits="Plugins_Quality_Fcheck_FqfFcheckInfo" %>
                        ...
                        <Items>
                            <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                ...
                                <Items>
                                    ...
                                    <ext:ComboBox ID="cbxliuhua" runat="server" FieldLabel="硫化机台" LabelAlign="Right" Editable="true" >
                                    </ext:ComboBox>
                                </Items>
                            </ext:Container>
                            ...
                            <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".25" 
                                Padding="5">
                                <Items>
                                    <ext:TextField ID="txtPDM" runat="server" FieldLabel="PDM编码" LabelAlign="Right" Editable="false"></ext:TextField>
                                    <ext:ComboBox ID="cbxDefect" runat="server" FieldLabel="病疵" LabelAlign="Right" Editable="false" Hidden="true" >
                                    </ext:ComboBox>
                                    ...
                                    <ext:ComboBox ID="cbxchengxing" runat="server" FieldLabel="成型机台" LabelAlign="Right" Editable="true" >
                                    </ext:ComboBox>
                                </Items>
                            </ext:Container>
                        </Items>
                                    ...
                                    <Model>
                                        <ext:Model ID="modelDetail" runat="server" IDProperty="OBJID">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="M_TIME" Type="Date"/>
                                                <ext:ModelField Name="C_TIME" Type="Date"/>
                                                <ext:ModelField Name="首检人" />
                                                <ext:ModelField Name="首检时间" Type="Date"/>
                                                <ext:ModelField Name="自检人" />
                                                <ext:ModelField Name="自检时间" Type="Date"/>
                                                <ext:ModelField Name="复检人" />
                                                <ext:ModelField Name="复检时间" Type="Date"/>
                                            </Fields>
                                        </ext:Model>
                                    </Model>
                                    <%--<Parameters>
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MATERIAL_NAME_DETAIL" runat="server" Text="规格" Width="240" DataIndex="MATERIAL_NAME"/>
                                     <ext:Column ID="Column4" runat="server" Text="PDM编码" DataIndex="PDM_CODE" />
                                    ...
                                    <ext:DateColumn ID="M_TIME" runat="server" Text="成型时间" Width="200" DataIndex="M_TIME" Format="yyyy-MM-dd HH:mm:ss"/>
                                    ...
                                    <ext:DateColumn ID="C_TIME" runat="server" Text="硫化时间" Width="200" DataIndex="C_TIME" Format="yyyy-MM-dd HH:mm:ss"/>
                                    ...
                                    <ext:Column ID="Column1" runat="server" Text="首检人" DataIndex="首检人" Width="100"/>
                                    <ext:DateColumn ID="DateColumn1" runat="server" Text="首检时间" Width="160" DataIndex="首检时间" Format="yyyy-MM-dd HH:mm:ss"/>
                                    <ext:Column ID="Column2" runat="server" Text="自检人" DataIndex="自检人" Width="100"/>
                                    <ext:DateColumn ID="DateColumn2" runat="server" Text="自检时间" Width="160" DataIndex="自检时间" Format="yyyy-MM-dd HH:mm:ss"/>
                                    <ext:Column ID="Column3" runat="server" Text="复检人" DataIndex="复检人" Width="100"/>
                                    <ext:DateColumn ID="DateColumn3" runat="server" Text="复检时间" Width="160" DataIndex="复检时间" Format="yyyy-MM-dd HH:mm:ss"/>
                                </Columns>
                            </ColumnModel>
                          <%--  <SelectionModel>
