<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SbeALvDetail.aspx.cs" Inherits="Plugins_Quality_SbeALvDetail" %>
                            ...
                            <Items>
                                ...
                                <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                    ...
                                    <Items>
                                        ...
                                        <ext:TextField ID="txttyre" runat="server" FieldLabel="条码号" MaxLength="25"
                                            LabelAlign="Right" />
