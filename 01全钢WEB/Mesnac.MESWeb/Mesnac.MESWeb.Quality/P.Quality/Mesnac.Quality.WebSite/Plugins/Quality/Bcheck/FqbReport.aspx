<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FqbReport.aspx.cs" Inherits="Plugins_Quality_Bcheck_FqbReport" %>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" IDProperty="OBJID">
                                            <Fields>
                                                ...
                                                <%--<ext:ModelField Name="LTOARANK" />
                                                <ext:ModelField Name="LBOARANK" />--%>
                            ...
                            <ColumnModel ID="ColumnModel" runat="server">
                                <Columns>
                                    ...
                                    <%--<ext:Column ID="LTOARANK" runat="server" Text="上侧向跳动A" DataIndex="LTOARANK" Flex="1" />
                                    <ext:Column ID="LBOARANK" runat="server" Text="下侧向跳动A" DataIndex="LBOARANK" Flex="1" />--%>
