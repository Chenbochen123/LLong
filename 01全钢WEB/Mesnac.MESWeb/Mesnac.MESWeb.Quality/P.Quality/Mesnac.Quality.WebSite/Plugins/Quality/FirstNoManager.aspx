<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstNoManager.aspx.cs" Inherits="Plugins_Quality_FirstNoManager" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_editdefect = function (record) {
            ...
            var DefectName = record.data.NO_REASON;
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="NO_REASON" runat="server" Text="原因" DataIndex="NO_REASON" Width="360" />
