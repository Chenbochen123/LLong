<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FqbUCheckTotal.aspx.cs" Inherits="Plugins_Quality_Ucheck_FqbUCheckTotal" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpFcheckInfo" runat="server" Layout="border">
            <Items>
                ...
                <ext:Panel ID="pnlDetail" runat="server" Region="South" Title="检验数据" Height="550" Width="600" Icon="Basket" Layout="Fit" 
                    Split="true" MarginsSummary="0 5 5 5" AutoScroll="true">
                    <Items>
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            <Store>
                                <ext:Store ID="storeData" runat="server" PageSize="100">
                                    ...
                                    <Model>
                                        <ext:Model ID="modelDetail" runat="server"  >
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="JUNYUNHEGE" />
                                                <ext:ModelField Name="DONGHEGE" />
                                                <ext:ModelField Name="HEGELV" />
                                                <ext:ModelField Name="JUNHEGELV" />
                                                <ext:ModelField Name="ZONGHEGESHU" />
                                            </Fields>
                                        </ext:Model>
                                    </Model>
                                </ext:Store>
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column60" runat="server" Text="检测总数量" DataIndex="TOTAL" Width="100" />
                                    <ext:Column ID="Column1" runat="server" Text="均匀性A数量" DataIndex="JUNYUNHEGE" Width="100" />
                                    <ext:Column ID="Column54" runat="server" Text="均匀性合格率%" DataIndex="JUNHEGELV" Width="100" />
                                    <ext:Column ID="Column53" runat="server" Text="动平衡A数量" DataIndex="DONGHEGE" Width="100" />
                                    <ext:Column ID="Column3" runat="server" Text="总合格数量" DataIndex="ZONGHEGESHU" Width="100" />
                                    <ext:Column ID="Column2" runat="server" Text="总合格率%" DataIndex="HEGELV" Width="100" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
