<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FqxQualityReport.aspx.cs" Inherits="Plugins_Quality_QualityReport" %>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="totalCount" runat="server" Text="库存数量" DataIndex="检查数量" Width="100" />
