<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BqcRecord.aspx.cs" Inherits="Plugins_Quality_Ocheck_BqcRecord" %>
       ...
       <asp:Button ID="btnExportSubmit" Style="display: none" runat="server" Text="Button"
        ...
        <ext:Viewport ID="vpQCRecord" runat="server" Layout="border">
            <Items>
                ...
                <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5" Title="人工质检信息">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="colModel" runat="server">                              
                                ...
                                <Columns>
                                    ...
                                    <ext:Column ID="Column1" runat="server" Text="质检人" DataIndex="QCHECK" Width="70" />
                                    <ext:Column ID="Column2" runat="server" Text="质检时间" DataIndex="CHECK_TIME" Width="150" />
                                    <ext:Column ID="C_NAME" runat="server" Text="硫化机台号" DataIndex="C_NAME" Width="100" />
                                    <ext:Column ID="CB_TIME" runat="server" Text="硫化开始时间" DataIndex="CB_TIME" Width="150" Format="yyyy-MM-dd "/>
                                    <ext:Column ID="CE_TIME" runat="server" Text="硫化结束时间" DataIndex="CE_TIME" Width="150" Format="yyyy-MM-dd " />
                                    ...
                                    <ext:Column ID="MB_TIME" runat="server" Text="成型生产开始时间" DataIndex="MB_TIME" Width="150" Format="yyyy-MM-dd "  />
                                    <ext:Column ID="ME_TIME" runat="server" Text="成型生产结束时间" DataIndex="ME_TIME" Width="150" Format="yyyy-MM-dd "  />
                                    <ext:Column ID="MU_NAME1" runat="server" Text="成型主机手" DataIndex="MU_NAME1" Width="90" />
                                    <ext:Column ID="MU_NAME2" runat="server" Text="成型副机手" DataIndex="MU_NAME2" Width="90" />
                                    <ext:Column ID="MU_NAME3" runat="server" Text="帮车" DataIndex="MU_NAME3" Width="100" />
                                    <ext:Column ID="GRADENAME" runat="server" Text="品级" DataIndex="GRADENAME" Width="60" />
