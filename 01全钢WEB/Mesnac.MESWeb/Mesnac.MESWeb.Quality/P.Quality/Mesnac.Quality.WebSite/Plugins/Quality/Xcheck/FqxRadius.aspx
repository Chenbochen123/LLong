<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FqxRadius.aspx.cs" Inherits="Plugins_Quality_Xcheck_fqxRadius" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var pnListSave = function () {
            Ext.Msg.confirm("提示", '您确定要保存修改的数据吗？', function (btn) {
                if (btn != "yes") { return; }
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpQualityStandard" runat="server" Layout="border">
            <Items>
                ...
                <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5" Title="防擦半径标准">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" IDProperty="OBJID">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="RADIUS" />
                                                <ext:ModelField Name="TYRE_HEIGHT" />
                                            </Fields>
                                        </ext:Model>
                                    </Model>
                                </ext:Store>
                            ...
                            <ColumnModel ID="colModel" runat="server">
                             ...
                             <%--       <ext:Column ID="Column1" runat="server" Text="编号" DataIndex="OBJID" Flex="1" />--%>
                                    ...
                                    <ext:Column ID="RADIUS" runat="server" Text="防擦半径" DataIndex="RADIUS" Flex="1">
                                        <Editor>
                                            <ext:TextField runat="server" ID="RADIUS_EDITOR" />
                                        </Editor>
                                    </ext:Column>
                                     <ext:Column ID="TYRE_HEIGHT" runat="server" Text="轮胎高度" DataIndex="TYRE_HEIGHT" Flex="1">
                                        <Editor>
                                            <ext:TextField runat="server" ID="TYRE_HEIGHT_EDITOR" />
                                        </Editor>
                                    </ext:Column>
                                </Columns>
                            </ColumnModel>
