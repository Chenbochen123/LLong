<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FqxXcheckDefectPercent.aspx.cs" Inherits="Plugins_Quality_Xcheck_FqxXcheckDefectPercent" %>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox ID="cbxShift" runat="server" FieldLabel="班次" LabelAlign="Right" Hidden="true" Editable="false"></ext:ComboBox>
                                    </Items>
                                </ext:Container>
                            </Items>
                            <Listeners>
                        ...
                        <ext:GridPanel ID="pnlDefectList" runat="server">
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column1" runat="server" Text="" DataIndex="" Flex="1" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MATERIAL_NAME_DETAIL" runat="server" Text="规格" DataIndex="MATERIAL_NAME" Width="300" />
                                    ...
                                    <ext:Column ID="EQUIPNAME" runat="server" Text="质检机台" DataIndex="EQUIP_NAME" />
                                    ...
                                    <ext:DateColumn ID="RECORD_TIME" runat="server" Text="质检时间" DataIndex="RECORD_TIME" Format="yyyy-MM-dd HH:mm:ss" />
