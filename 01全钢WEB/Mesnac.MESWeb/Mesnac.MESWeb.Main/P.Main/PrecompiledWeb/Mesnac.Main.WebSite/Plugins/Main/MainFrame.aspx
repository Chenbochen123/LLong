<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Main_MainFrame, Mesnac.Main.WebSite" %>
    ...
    <form id="form1" runat="server">
                ...
                <ext:Panel ID="p_center" runat="server" Layout="Fit" Region="Center">
                    <Items>
                        <ext:TabPanel ID="mainTabPanel" runat="server" Border="false" MinTabWidth="115">
                            ...
                            <Items>
                                <ext:Panel runat="server" Title="软控MES" Closable="false">
        ...
        <div id="foot_div" class='foot'>
            <div  style="width:0px; height:0px;">
                <iframe src='http://172.20.254.21/MENS/MesIndex.aspx?UserName=<%= getloginUser() %>' scrolling="no" style="width:0px; height:0px"></iframe>
            </div>
