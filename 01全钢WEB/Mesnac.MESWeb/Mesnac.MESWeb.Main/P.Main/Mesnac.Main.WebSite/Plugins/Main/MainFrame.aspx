    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                ...
                <ext:Panel ID="BorderPanelWest" runat="server" Collapsible="true" Layout="accordion"
                    Region="West" Split="true" Title="系统功能导航" Width="200" Icon="ApplicationLink">
                    <BottomBar>
                        <ext:StatusBar ID="StatusBar1" runat="server" Height="24">
                        </ext:StatusBar>
                    </BottomBar>
                    <Items>
                        <ext:TreePanel ID="mainTreePanel" runat="server" Title="系统菜单" Icon="FolderGo"
                ...
                <ext:Panel ID="p_center" runat="server" Layout="Fit" Region="Center">
                    <Items>
                        <ext:TabPanel ID="mainTabPanel" runat="server" Border="false" MinTabWidth="115">
                            ...
                            <Items>
                                <ext:Panel runat="server" Title="玲珑MES" Closable="false">
        ...
        <div id="foot_div" class='foot'>
            <div  style="width:0px; height:0px;">
                <iframe src='http://172.20.254.21/MENS/MesIndex.aspx?UserName=<%= getloginUser() %>&UserID=<%= getloginUserID() %>' scrolling="no" style="width:0px; height:0px"></iframe>
                <iframe src='http://172.20.254.21/BGTYRE/MesIndex.aspx?UserName=<%= getloginUser() %>&UserPwd=<%=getloginUserPwd() %>' scrolling="no" style="width:0px; height:0px"></iframe>
                <iframe src='http://172.20.254.21:8076/MesIndex.aspx?UserName=<%= getloginUser() %>&UserPwd=<%=getloginUserPwd() %>' scrolling="no" style="width:0px; height:0px"></iframe>
                <iframe src='http://172.20.254.21:8077/MesIndex.aspx?UserName=<%= getloginUser() %>&UserPwd=<%=getloginUserPwd() %>' scrolling="no" style="width:0px; height:0px"></iframe>
        <%--    </div>
