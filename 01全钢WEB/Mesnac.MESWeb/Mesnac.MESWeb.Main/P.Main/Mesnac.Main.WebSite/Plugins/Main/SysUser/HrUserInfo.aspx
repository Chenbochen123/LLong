<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HrUserInfo.aspx.cs" Inherits="Plugins_Main_SysUser_HrUserInfo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        //-------岗位-----查询带回弹出框--BEGIN
        var McUI_SearchBox_SearchBoxSsbWork_Request = function (record) {//岗位返回值处理
            if (!App.winModify.hidden) {
    ...
    <script type="text/javascript">
        var LoginState = function (value) {
            return Ext.String.format((value != null && value > 0) ? "未禁止" : "已禁止");
        };
    </script>
</head>
<body>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="HR_CODE" runat="server" Text="人员编号" DataIndex="HR_CODE" Width="80" />
                            ...
                            <ext:Column ID="LENPWD" runat="server" Text="禁止登陆" DataIndex="LENPWD" Width="60">
                                    ...
                                    <Items>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                ...
                                                <ext:ComboBox ID="modify_sex" runat="server" FieldLabel="性别" LabelAlign="Left" Enabled="false"
