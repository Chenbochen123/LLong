var viewportAfterRender = function () {
    ...
    App.ui_s_BeginTransferDate.setValue(null);
    App.ui_s_EndTransferDate.setValue(null);
    ...
    App.ui_s_BeginTransferDate.hide();
    App.ui_s_EndTransferDate.hide();
};
...
var set_ui_s_SearchType = function (value) {
    ...
    if (value == "1") {
        ...
        {
            // 之前是按出库日期
            beginDate = Ext.Date.parse(App.ui_s_BeginTransferDate.rawValue);
            endDate = Ext.Date.parse(App.ui_s_EndTransferDate.rawValue);
        }
        ...
        {
            // 之前是按出库日期
            beginDate = App.ui_s_BeginTransferDate.value;
            endDate = App.ui_s_EndTransferDate.value;
        }
        // 结束日期按接班日期加1天
        ...
        App.ui_s_BeginTransferDate.setValue(beginDate);
        App.ui_s_EndTransferDate.setValue(endDate);
        App.ui_s_BeginTime_Date.setValue(null);
        App.ui_s_BeginTime_Time.setValue(null);
        App.ui_s_EndTime_Date.setValue(null);
        App.ui_s_EndTime_Time.setValue(null);
        ...
        App.ui_s_BeginDate.hide();
        App.ui_s_EndDate.hide();
        App.ui_s_BeginTransferDate.show();
        App.ui_s_EndTransferDate.show();
    }
