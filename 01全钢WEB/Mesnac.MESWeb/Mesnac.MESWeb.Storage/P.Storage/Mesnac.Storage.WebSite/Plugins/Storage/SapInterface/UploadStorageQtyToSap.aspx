<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadStorageQtyToSap.aspx.cs" Inherits="Plugins_Storage_SapInterface_UploadStorageQtyToSap" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            debugger;
            if (record.data.SUCCESS_FLAG != "新建" && record.data.SUCCESS_FLAG != "上传失败") {
            ...
            var RecStoloc = record.data.REC_STOLOC;
            var ShiftDate = record.data.SHIFT_DATE;
            var MaterialName = record.data.MATERIAL_NAME;
            var HeadTxt = record.data.HEAD_TXT;
            var RecBatch = record.data.REC_BATCH;
            var Reciever = record.data.RECIEVER;
            var Batch = record.data.BATCH;
            debugger;
            App.direct.commandcolumn_direct_edit(ObjId, ShiftDate, MaterialName, MaterialId, Qty, RecStoloc, HeadTxt, RecBatch, Reciever,Batch, {
        ...
        var commandcolumn_click_confirm = function (command, record) {
            ...
            if (command.toLowerCase() == "delete") {
                Ext.Msg.confirm("提示", '您确定需要删除未上传的入库信息吗？', function (btn) { commandcolumn_direct_delete(btn, record) });
            }
    ...
    <script type="text/javascript">
        ...
        var upload_product_qty_confirm = function (isall) {
            if (isall == 0) {
                Ext.Msg.confirm("提示", '您确认要上报选中的入库信息吗？', function (btn) {
                    if (btn != "yes") {
                        return;
                    }
                ...
                Ext.Msg.confirm("提示", '您确认要上报全部入库信息吗？', function (btn) {
                    if (btn != "yes") {
                        return;
                    }
                    ...
                    var box = App.CheckboxSelectionModel1.selected.items;
                    for (var i = 0 ; i < box.length; i++) {
                        if (box[i].data.SUCCESS_FLAG == "上传成功" || box[i].data.SUCCESS_FLAG == "上传中") {
                            Ext.Msg.alert("提示", "所选数据不能包含已上传信息！");
                            return;
                        }
                    }
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="border">
            <Items>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="barUser">
                            <Items>
                                ...
                                <ext:ComboBox runat="server" ID="cbxClass" Text="班组">
                                    <%--  <Listeners>
                                        <Change Fn="pnlListFresh" />
                                    </Listeners>--%>
                                </ext:ComboBox>
                                ...
                                <ext:ToolbarSeparator />
                                <ext:Button runat="server" Icon="Add" Text="添加入库信息" ID="btnAdd">
                                    <ToolTips>
                                        <ext:ToolTip ID="ttAdd" runat="server" Html="点击添加入库信息" />
                                    </ToolTips>
                                    <Listeners>
                                ...
                                <%-- <ext:Hidden runat="server" ID="hidHeadID"></ext:Hidden>--%>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="SHIFT_NAME" runat="server" Text="入库班次" DataIndex="SHIFT_NAME" Width="80" />
                            ...
                            <ext:Column ID="BATCH" runat="server" Text="报产批次" DataIndex="BATCH" Width="80" />
                        ...
                        <ext:GridPanel ID="GridPanel1" runat="server" MarginsSummary="0 5 5 5">
                            <Store>
                                <ext:Store ID="storeDetail" runat="server" PageSize="10">
                                    ...
                                    <Parameters>
                                        <ext:StoreParameter Name="OBJID" Mode="Raw" Value="#{GridPanel1}.getSelectionModel().hasSelection() ? #{GridPanel1}.getSelectionModel().getSelection()[0].data.OBJID : -1" />
                                    </Parameters>
                                </ext:Store>
                            </Store>
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="RETURN_MSG" runat="server" Text="返回消息" DataIndex="RETURN_MSG" Width="200" />
                    ...
                    <Items>
                        <ext:FormPanel ID="FormPanel1" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:ComboBox runat="server" ID="AddShift" FieldLabel="入库班次" LabelAlign="Right" />
                                ...
                                <ext:TextField runat="server" ID="AddQty" FieldLabel="入库数量" LabelAlign="Right" />
                                ...
                                <ext:TextField runat="server" ID="AddBatch" FieldLabel="报产批次" LabelAlign="Right" />
                ...
                <ext:Window ID="winEditProduct" runat="server" Icon="MonitorEdit" Closable="true"
                    Title="修改入库信息" Width="360" Height="360" Resizable="false" Hidden="true" Modal="true"
                    BodyStyle="background-color:#fff;" BodyPadding="5" Layout="FitLayout">
                    <Items>
                        <ext:FormPanel ID="FormPanel2" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:ComboBox runat="server" ID="EditCbxStoLoc" FieldLabel="收货库区" LabelAlign="Right" >
                                    <Listeners>
                                        <Change Fn="on_sto_loc_change" />
                                    </Listeners>
                                </ext:ComboBox>
                                <ext:TextField runat="server" ID="EditQty" FieldLabel="入库数量" LabelAlign="Right" />
                                <ext:ComboBox runat="server" ID="EditCbxRecBatch" FieldLabel="收货批次" LabelAlign="Right" />
                                <ext:TextField runat="server" ID="EditReciever" FieldLabel="收货人" LabelAlign="Right" />
                                <ext:TextField runat="server" ID="EditBatch" FieldLabel="报产批次" LabelAlign="Right" Hidden="true"/>
