<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Main_SysMenu_SetPageMenu, Mesnac.Main.WebSite" %>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column     ID="seq_idx"        runat="server" Text="排列序号" DataIndex="SEQ_IDX"          Width="60"      />
