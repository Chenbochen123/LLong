<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Storage_SapInterface_UploadStorageQtyToSap, Mesnac.Storage.WebSite" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            debugger;
            App.direct.commandcolumn_direct_edit(ObjId, ShiftDate, MaterialName, MaterialId, Qty, RecStoloc, HeadTxt, RecBatch, Reciever, {
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="border">
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <Store>
                        <ext:Store ID="store" runat="server" PageSize="80">
                            <Proxy>
