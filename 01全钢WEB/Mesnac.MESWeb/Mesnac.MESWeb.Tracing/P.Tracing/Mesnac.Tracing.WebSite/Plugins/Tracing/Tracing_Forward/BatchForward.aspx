<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BatchForward.aspx.cs" Inherits="Tracing_Forward_BatchForward" ViewStateMode="Enabled" EnableViewStateMac="true" EnableViewState="true" %>
                                ...
                                <ext:GridPanel runat="server" ID="GridPanel1" Region="Center" >
                                    ...
                                    <ColumnModel ID="columnModel3" runat="server">
                                        <Columns>
                                            ...
                                            <ext:Column ID="colShelf" runat="server" Hidden="true" Text="架子号" Width="200" DataIndex="SHELF_BARCODE" />
                                            ...
                                            <ext:Column ID="colSetWeight" runat="server" Text="设定重量" Width="200" DataIndex="SET_WEIGHT" Hidden="true" />
                                            <ext:Column ID="colRealWeight" runat="server" Text="实际重量" Width="200" DataIndex="REAL_WEIGHT" Hidden="true" />
