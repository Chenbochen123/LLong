<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Main_BaseInfo_DeptInfo, Mesnac.Main.WebSite" %>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="erp_code" runat="server" Text="ERP编码" DataIndex="ERP_CODE" Width="80"  />
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" MonitorValid="true" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TextField ID="add_erp_code" runat="server" FieldLabel="ERP编码" LabelAlign="Left" Editable="false"   />
