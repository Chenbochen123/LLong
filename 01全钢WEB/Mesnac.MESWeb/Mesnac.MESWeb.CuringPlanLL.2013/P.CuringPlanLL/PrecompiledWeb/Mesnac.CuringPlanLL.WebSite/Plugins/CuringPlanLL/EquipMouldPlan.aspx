<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Curing_ProductPlan_EquipMouldPlan, Mesnac.CuringPlanLL.WebSite" %>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" Text="左右模具" DataIndex="EQUIP_POSITION_NAME" Width="40" />
