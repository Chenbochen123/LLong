<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipDayPlan.aspx.cs" Inherits="Plugins_Curing_ProductPlan_EquipDayPlan" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            var zuomozao = record.data.zuomozao;
            var zuomozhong = record.data.zuomozhong;
            var zuomoye = record.data.zuomoye;
            var youmozao = record.data.youmozao;
            var youmozhong = record.data.youmozhong;
            var yongmoye = record.data.yongmoye;
            debugger;
            App.direct.commandcolumn_direct_edit(ObjId, jitai, wuliao, zuomozao, zuomozhong, zuomoye, youmozao, youmozhong, yongmoye, {
                success: function (result) {
                    // Ext.Msg.alert('操作', result);
                    pnlListFresh();
                },
    ...
    <script type="text/javascript">
        ...
        var del_plan_state_confirm = function (isall) {
            Ext.Msg.confirm("提示", '您确定需要删除计划吗？', function (btn) {
                if (btn != "yes") {
                    return;
                }
                App.direct.update_plan_state(isall);
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="border">
            <Items>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="barUser">
                            <Items>
                                ...
                                <ext:ToolbarSeparator />
                                <ext:Button runat="server" Icon="ShapesManySelect" Text="删除选中计划" ID="btnDelPlan">
                                    <ToolTips>
                                        <ext:ToolTip ID="ToolTip5" runat="server" Html="删除选中计划" />
                                    </ToolTips>
                                    <Listeners>
                                        <Click Handler="del_plan_state_confirm(2);" />
                                    </Listeners>
                                </ext:Button>
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" Text="生产工艺">
                                <Columns>
                                    <ext:Column runat="server" Text="BOM版本" DataIndex="bom" Width="110" />
                ...
                <ext:Window ID="winEditProduct" runat="server" Icon="MonitorEdit" Closable="true"
                    Title="修改计划数量" Width="360" Height="360" Resizable="false" Hidden="true" Modal="true"
                    BodyStyle="background-color:#fff;" BodyPadding="5" Layout="FitLayout">
                    <Items>
                        <ext:FormPanel ID="FormPanel2" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TextField runat="server" ID="EditQtyLeftZao" FieldLabel="左模早班数量" LabelAlign="Right" />
                                <ext:TextField runat="server" ID="EditQtyLeftZhong" FieldLabel="左模中班数量" LabelAlign="Right" />
                                <ext:TextField runat="server" ID="EditQtyLeftYe" FieldLabel="左模夜班数量" LabelAlign="Right" />
                                <ext:TextField runat="server" ID="EditQtyRightZao" FieldLabel="右模早班数量" LabelAlign="Right" />
                                <ext:TextField runat="server" ID="EditQtyRightZhong" FieldLabel="右模中班数量" LabelAlign="Right" />
                                <ext:TextField runat="server" ID="EditQtyRightYe" FieldLabel="右模夜班数量" LabelAlign="Right" />
