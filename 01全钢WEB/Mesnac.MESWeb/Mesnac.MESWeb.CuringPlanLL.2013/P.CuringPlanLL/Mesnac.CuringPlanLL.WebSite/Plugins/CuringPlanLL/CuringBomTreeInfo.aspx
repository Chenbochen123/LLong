<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CuringBomTreeInfo.aspx.cs" Inherits="Plugins_CuringPlanLL_CuringBomTreeInfo" %>
                            ...
                            <Items>
                                <ext:Container ID="containerQueryParam" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        ...
                                        <ext:TextField ID="txtPDM" Vtype="integer" runat="server" FieldLabel="PDM编码"
                                            LabelAlign="Right" />
                                    </Items>
                                </ext:Container>
                            </Items>
                        ...
                        <ext:TreePanel ID="treeCbm" runat="server" Title="物料信息" Region="Center" Icon="FolderGo" AutoHeight="true" RootVisible="false" MultiSelect="false">
                            ...
                            <ColumnModel>
                                <Columns>
                                    ...
                                    <ext:Column runat="server" Text="PDM编码" Width="100" Sortable="true" DataIndex="PDM_CODE" />
                                    <ext:Column runat="server" Text="系列" Width="100" Sortable="true" DataIndex="TYPENAME" />
                                    <ext:Column runat="server" Text="胎胚版本" Width="100" Sortable="true" DataIndex="GREENTYRE_VERSION" />
