<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanScrollSearch.aspx.cs" Inherits="Plugins_Curing_ProductPlan_PlanScrollSearch" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var pnlListFresh = function () {
            window.open("PlanScroll.aspx?EquipID=" + App.hiddenEquipID.getValue() + "&&MaterCode=" + App.hiddenMaterCode.getValue(), "_blank");
        ...
        var McUI_SearchBox_SearchBoxCuringEquip_Request = function (record) {//库房信息返回值处理
        ...
        var McUI_SearchBox_SearchBoxSbmMaterialCuring_Request = function (record) {
