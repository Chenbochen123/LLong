<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MoldingStorage.aspx.cs" Inherits="Plugins_Molding_Storage_MoldingStorage" %>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="3">
                                    <Items>
                                        <ext:FieldContainer runat="server" FieldLabel="开始时间" Layout="HBoxLayout" LabelAlign="Right" Hidden="true">
                                            <Items>
                                                <ext:DateField ID="txtBeginDate" runat="server" Width="150" Flex="1" Editable="false" />
                                                <ext:TimeField ID="txtBeginTime" runat="server" Width="90"  Editable="true" />
                                            </Items>
                                        </ext:FieldContainer>
                                        <ext:FieldContainer runat="server" FieldLabel="结束时间" Layout="HBoxLayout" LabelAlign="Right" Hidden="true">
                                            <Items>
                                                <ext:DateField ID="txtEndDate" runat="server" Width="150" Flex="1" Editable="false" />
                                                <ext:TimeField ID="txtEndTime" runat="server" Width="90"  Editable="true" />
                                            </Items>
                                        </ext:FieldContainer>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MATERIAL_FULL_NAME" runat="server" Text="规格" DataIndex="MATERIAL_FULL_NAME" Width="250" />
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MATERIAL_FULL_NAME1" runat="server" Text="规格" DataIndex="MATERIAL_FULL_NAME" Width="250" >
                                         <Renderer Fn="Barcode_Renderer" />
                                    </ext:Column>
                                    <ext:Column ID="SAP_CODE1" runat="server" Text="Sap号" DataIndex="SAP_CODE" Flex="1" >
                                         <Renderer Fn="Barcode_Renderer" />
                                    </ext:Column>
                                    <ext:Column ID="STORE_NAME" runat="server" Text="仓库" DataIndex="STORE_NAME" Flex="1" >
                                         <Renderer Fn="Barcode_Renderer" />
                                    </ext:Column>
                                    ...
                                    <ext:DateColumn ID="RECORD_TIME" runat="server" Text="入库时间" DataIndex="RECORD_TIME" Flex="1" Format="yyyy-MM-dd HH24:mm:ss" >
                                    <Renderer Fn="Barcode_Renderer" />
                                    </ext:DateColumn>
