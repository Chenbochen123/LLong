<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialTimeSet.aspx.cs" Inherits="Plugins_Molding_ProductPlan_MaterialTimeSet" %>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="barRubber">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="Bell" Text="设置停放时间" ID="btn_set_stock">
                                    <ToolTips>
                                        <ext:ToolTip ID="ToolTip4" runat="server" Html="点击设置停放时间" />
                                    </ToolTips>
                                    <DirectEvents>
                                ...
                                <ext:Button runat="server" Icon="Bell" Text="批量恢复默认有效期" ID="Button1">
                                    <ToolTips>
                                        <ext:ToolTip ID="ToolTip1" runat="server" Html="点击批量恢复默认有效期" />
                                    </ToolTips>
                                    <DirectEvents>
                                        <Click OnEvent="btn_set_Stand_Click">
                                            <ExtraParams>
                                                <ext:Parameter Name="StockValues" Value="Ext.encode(#{pnlList}.getRowsValues({selectedOnly:true}))" Mode="Raw" />
                                            </ExtraParams>
                                        </Click>
