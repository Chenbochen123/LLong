<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipDayPlanDetail.aspx.cs" Inherits="Plugins_Molding_ProductPlan_EquipDayPlanDetail" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        var SearchMoldingPlanMaterialWindowShow = function () {//物料查询
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="border">
            <Items>
                <ext:GridPanel ID="GridPanel1" runat="server" Flex="1" Region="Center" Collapsible="false" MultiSelect="true" FolderSort="true"
                    Title="成型机台信息" TitleAlign="Center">
                    <Store>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="barUser">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="Add" Text="选择计划物料" ID="btnAdd">
                                    <ToolTips>
                                        <ext:ToolTip ID="ttAdd" runat="server" Html="点击选择计划物料" />
                                    </ToolTips>
                                    <Listeners>
                                        <Click Fn="SearchMoldingPlanMaterialWindowShow" />
                                    </Listeners>
                                </ext:Button>
                            ...
                            <Items>
                                <ext:Container ID="container15" runat="server" Layout="FormLayout" ColumnWidth=".8">
                                    <Items>
                                        ...
                                        <ext:MenuSeparator Hidden="false" />
