<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BqcWeightQuality.aspx.cs" Inherits="Plugins_MoldingBG_Quality_BqcWeightQuality" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>胎胚重量合格率查询</title>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpQCRepair" runat="server" Layout="border">
            <Items>
                ...
                <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5" Title="胎胚重量合格率">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="TYRE_NO" runat="server" Text="机台" DataIndex="EQUIP_NAME" Width="100" />
                                    <ext:Column ID="CURING_MATER_NAME" runat="server" Text="班次" DataIndex="SHIFT_NAME" Width="100" />
                                    <ext:Column ID="CURING_MATER_CODE" runat="server" Text="胎胚规格" DataIndex="MATERIAL_NAME" Width="200" />
                                    <ext:Column ID="CURING_GRADE" runat="server" Text="总数" DataIndex="AMOUNT" Width="100" />
                                    <ext:Column ID="GREEN_TYRE_NO" runat="server" Text="合格数" DataIndex="HEGE" Width="100" />
                                    <ext:Column ID="Column1" runat="server" Text="合格率" DataIndex="HEGELV" Width="100">
