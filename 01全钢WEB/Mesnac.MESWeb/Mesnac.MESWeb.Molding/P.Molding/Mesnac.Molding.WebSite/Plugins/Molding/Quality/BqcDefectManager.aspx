<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BqcDefectManager.aspx.cs" Inherits="Plugins_Molding_BqcDefectManager" %>
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                <ext:RowNumbererColumn ID="rowNumCol1" runat="server" Width="35" />
                                 <ext:Column ID="DefectCode" runat="server" Text="病疵编号" DataIndex="DEFECT_CODE" Width="60" />
