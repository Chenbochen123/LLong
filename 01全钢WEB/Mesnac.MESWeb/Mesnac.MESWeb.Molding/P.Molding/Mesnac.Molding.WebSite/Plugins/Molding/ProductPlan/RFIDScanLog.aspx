<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RFIDScanLog.aspx.cs" Inherits="Plugins_Molding_ProductPlan_RFIDScanLog" %>
                            ...
                            <Items>
                                ...
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                    ...
                                    <Items>
                                        ...
                                        <ext:ComboBox ID="scanResult" runat="server" FieldLabel="是否成功" LabelAlign="Right" Editable="false"></ext:ComboBox>
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="SCAN_TYPE" runat="server" Text="扫描类型" DataIndex="SCAN_TYPE" Flex="1" />
