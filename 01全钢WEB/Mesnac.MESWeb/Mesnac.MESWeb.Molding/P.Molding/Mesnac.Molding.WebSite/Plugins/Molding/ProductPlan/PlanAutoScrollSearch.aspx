<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanAutoScrollSearch.aspx.cs" Inherits="Plugins_Molding_ProductPlan_PlanAutoScrollSearch" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var pnlListFresh = function () {
            window.open("PlanAutoScroll.aspx?EquipID=" + App.hiddenEquipID.getValue() + "&&MaterCode=" + App.hiddenMaterCode.getValue() + "&&PlanDate=" + Ext.Date.format(App.PlanDate.getValue(), "Y-m-d"), "_blank");
        ...
        Ext.create("Ext.window.Window", {//库房查询带窗体
            ...
            hidden: true,
            width: 360,
            html: "<iframe src='" + thisRootUrl + "McUI/SearchBox/SearchBoxCbeMoldingEquip.aspx' width=100% height=100% scrolling=no  frameborder=0></iframe>",
        ...
        var McUI_SearchBox_SearchBoxCbeMoldingEquip_Request = function (record) {//库房信息返回值处理
