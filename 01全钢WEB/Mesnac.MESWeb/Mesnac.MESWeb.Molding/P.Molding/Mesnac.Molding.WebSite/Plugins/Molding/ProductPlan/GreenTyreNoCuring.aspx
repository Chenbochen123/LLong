<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GreenTyreNoCuring.aspx.cs" Inherits="Plugins_Molding_ProductPlan_GreenTyreNoCuring" %>
                        ...
                        <ext:GridPanel ID="pnlRatioList" runat="server">
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="NO_CURING_COUNT" runat="server" Text="未硫化数量" DataIndex="NO_CURING_COUNT" Width="200" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="STORE_PLACE_CODE" runat="server" Text="库位" DataIndex="STORE_PLACE_CODE"  Flex="1" />
