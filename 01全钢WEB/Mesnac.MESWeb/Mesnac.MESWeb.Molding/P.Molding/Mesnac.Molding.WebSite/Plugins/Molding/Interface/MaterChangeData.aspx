<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterChangeData.aspx.cs" Inherits="Plugins_Molding_Interface_MaterChangeData" %>
                    ...
                    <Items>
                        <ext:FormPanel ID="FormPanel2" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TriggerField runat="server" ID="tgrEditMaterialCode" ReadOnly="true" Enabled="false" Editable="false" FieldLabel="胎胚规格" LabelAlign="Right">
                                    <Triggers>
                                        <ext:FieldTrigger Icon="Clear" Qtip="清空" />
                                        <ext:FieldTrigger Icon="Search" Qtip="查找" />
                                    </Triggers>
