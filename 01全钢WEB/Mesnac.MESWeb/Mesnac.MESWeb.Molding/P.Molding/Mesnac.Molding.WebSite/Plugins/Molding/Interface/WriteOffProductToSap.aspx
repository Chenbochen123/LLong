<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WriteOffProductToSap.aspx.cs" Inherits="Plugins_Molding_Interface_WriteOffProductToSap" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_click_confirm = function (command, record) {
            ...
            if (command.toLowerCase() == "delete") {
                Ext.Msg.confirm("提示", '您确定需要删除未冲销的产量吗？', function (btn) { commandcolumn_direct_delete(btn, record) });
            }
    ...
    <script type="text/javascript">
        ...
        var upload_product_qty_confirm = function (isall) {
            if (isall == 0) {
                Ext.Msg.confirm("提示", '您确认要冲销选中的产量吗？', function (btn) {
                    if (btn != "yes") {
                        return;
                    }
                ...
                Ext.Msg.confirm("提示", '您确认要冲销全部产量吗？', function (btn) {
                    if (btn != "yes") {
                        return;
                    }
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="border">
            <Items>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="barUser">
                            <Items>
                                ...
                                <ext:ToolbarSeparator />
                                <ext:Button runat="server" Icon="Add" Text="添加冲产" ID="btnAdd">
                                    <ToolTips>
                                        <ext:ToolTip ID="ttAdd" runat="server" Html="点击添加冲产" />
                                    </ToolTips>
                                    <Listeners>
                                ...
                                <ext:ToolbarSeparator />
                                <ext:Button runat="server" Icon="ShapesManySelect" Text="冲销选中产量" ID="btnCheckProductionState">
                                    <ToolTips>
                                        <ext:ToolTip ID="ttSearch" runat="server" Html="冲销选中产量" />
                                    </ToolTips>
                                    <Listeners>
                                ...
                                <ext:Button runat="server" Icon="ShapesMany" Text="冲销全部产量" ID="btnAllProductionState">
                                    <ToolTips>
                                        <ext:ToolTip ID="ToolTip1" runat="server" Html="冲销全部产量" />
                                    </ToolTips>
                                    <Listeners>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="QTY" runat="server" Text="冲销产量" DataIndex="QTY" Width="80" />
                            ...
                            <ext:Column ID="REJECTQTY" runat="server" Text="冲销废品数量" DataIndex="REJECT_QTY" Width="80" />
                ...
                <ext:Window ID="winAddProduct" runat="server" Icon="MonitorAdd" Closable="true"
                    Title="添加冲销信息" Width="360" Height="360" Resizable="false" Hidden="true" Modal="true"
                    ...
                    <Items>
                        <ext:FormPanel ID="FormPanel1" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TriggerField runat="server" ID="tgrAddMaterialCode" FieldLabel="胎胚规格" Editable="false" LabelAlign="Right">
                                    <Triggers>
