<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BpmCarSize.aspx.cs" Inherits="Plugins_Molding_BpmCarSize" %>
        ...
        <ext:Viewport ID="vpDefect" runat="server" Layout="border">
            <Items>
                <ext:Panel ID="pnDefect" runat="server" Region="North">
                    ...
                    <Items>
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true"
                            Collapsible="false">
                            <Items>
                                <ext:TextField ID="txtcar" runat="server" FieldLabel="车条码" LabelAlign="Right"/>
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
                <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5 ">
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column5" runat="server" Text="胎胚车" DataIndex="CARNO" Width="120" />
                                    <ext:Column ID="Column6" runat="server" Text="胎胚车规格种类" DataIndex="SIZE1" Width="120" />
                                    <ext:Column ID="Column7" runat="server" Text="备注" DataIndex="REMARK" Width="90" Hidden="true"/>
                  ...
                  <ext:Window ID="winAddMouldDrum" runat="server" Icon="MonitorAdd" Closable="true" Title="添加胎胚车"
                                ...
                                <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="addcar" runat="server" FieldLabel="胎胚车号"
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TextField ID="txtremark" runat="server" FieldLabel="备注" LabelAlign="Right" Hidden="true"/>
                                    </Items>
                                </ext:Container>
                            </Items>
                        </ext:FormPanel>
