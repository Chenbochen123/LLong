<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shigong.aspx.cs" Inherits="Plugins_Molding_Technology_Shigong" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpMoldingStorage" runat="server" Layout="border">
            <Items>
                ...
                <ext:TabPanel runat="server" ID="tabPanelMain" Region="Center" AutoScroll="true" Flex="3">
                    <Items>

                        <ext:Panel runat="server" Region="South" ID="panelDetailInfo" Title="一段施工表" Layout="Fit">
                        ...
                        <ext:Panel ID="Panel2" runat="server" Title="二段施工表" Layout="Fit" ActiveIndex="2" ActiveItem="2">
                            <Loader runat="server" Mode="frame">
                            </Loader>
                            <Items>
                                <ext:GridPanel ID="GridPanel1" runat="server" MarginsSummary="0 5 5 5">
                                    <Store>
                                        <ext:Store ID="storeDetail2" runat="server" PageSize="10">
