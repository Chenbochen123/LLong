<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SemisDayPlanDetail.aspx.cs" Inherits="Plugins_Semis_SemisPlan_SemisDayPlanDetail" %>
                        ...
                        <ext:Toolbar runat="server" ID="barUser">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="Add" Text="选择计划物料" ID="btnAdd">
                                    ...
                                    <Listeners>
                                        <Click Fn="SearchSemisPlanMaterialWindowShow" />
                                    </Listeners>
                                </ext:Button>
