<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SemisMaterialProdCode.aspx.cs" Inherits="Plugins_Semis_SemisMaterialProdCode" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpQualityStandard" runat="server" Layout="border">
            <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox runat="server" ID="cbxMaterMinor" FieldLabel="物料细类" LabelAlign="Right" Editable="false"></ext:ComboBox>
                                    </Items>
                                </ext:Container>
                ...
                <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5" Title="物料项目代码">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" IDProperty="OBJID">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="MATERIAL_PROD_CODE" />
                                                <ext:ModelField Name="SINGLEWEIGHT" />
                                                <ext:ModelField Name="SINGLELENGTH" />
                                            </Fields>
                                        </ext:Model>
                                    </Model>
                                </ext:Store>
                            ...
                            <ColumnModel ID="colModel" runat="server">
                             ...
                             <%--       <ext:Column ID="Column1" runat="server" Text="编号" DataIndex="OBJID" Flex="1" />--%>
                                    ...
                                    <ext:Column ID="MATERIAL_PROD_CODE" runat="server" Text="物料项目代码" DataIndex="MATERIAL_PROD_CODE" Flex="1">
                                        <Editor>
                                            <ext:TextField runat="server" ID="MATERIAL_PROD_CODE_EDITOR" />
                                        </Editor>
                                    </ext:Column>
                                    <ext:Column ID="SINGLEWEIGHT" runat="server" Text="单重" DataIndex="SINGLEWEIGHT" Flex="1">
                                        <Editor>
                                            <ext:TextField runat="server" ID="SINGLEWEIGHT_EDITOR" />
                                        </Editor>
                                    </ext:Column>
                                    <ext:Column ID="SINGLELENGTH" runat="server" Text="单条长" DataIndex="SINGLELENGTH" Flex="1">
                                        <Editor>
                                            <ext:TextField runat="server" ID="SINGLELENGTH_EDITOR" />
                                        </Editor>
                                    </ext:Column>
                                </Columns>
                            </ColumnModel>
