<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryBasStoragePlace.aspx.cs" Inherits="Plugins_Semis_BasicInfo_CommonPage_QueryBasStoragePlace" %>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="STORE_NAME" DataIndex="StorageName" runat="server" Text="库房名称" Width="120" />
                            <ext:Column ID="STORE_PLACE_NAME" DataIndex="StoragePlaceName" runat="server" Text="库位名称" Width="120" />
