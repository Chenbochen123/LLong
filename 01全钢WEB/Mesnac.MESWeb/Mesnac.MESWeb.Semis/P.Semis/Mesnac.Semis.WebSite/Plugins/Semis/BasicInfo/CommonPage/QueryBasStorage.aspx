<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryBasStorage.aspx.cs" Inherits="Plugins_Semis_BasicInfo_CommonPage_QueryBasStorage" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Plugins_Semis_BasicInfo_CommonPage_QueryBasStorage_Request(record);
            parent.App.Plugins_Semis_BasicInfo_CommonPage_QueryBasStorage_Window.close();
            return false;
        }
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="storageName" DataIndex="STORE_NAME" runat="server" Text="库房名称" Width="120" />
