<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryMaterial.aspx.cs" Inherits="Plugins_Semis_BasicInfo_CommonPage_QueryMaterial" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Plugins_Semis_BasicInfo_CommonPage_QueryMaterial_Request(record);
            parent.App.Plugins_Semis_BasicInfo_CommonPage_QueryMaterial_Window.close();
            return false;
        }
                                    ...
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                ...
                                                <ext:TextField ID="txtSapName" FieldLabel="SAP编号" LabelAlign="Right" runat="server">
                                                    <Listeners>
                                                        <Change Fn="gridPanelRefresh"></Change>
                                                    </Listeners>
                                                </ext:TextField>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="material_name" runat="server" Text="物料名称" DataIndex="MATERIAL_NAME" Width="140"  />
                            <ext:Column ID="sap_code" runat="server" Text="sap编码" DataIndex="SAP_CODE" Width="90"  />
                            <ext:Column ID="material_minor" runat="server" Text="物料小类" DataIndex="MINOR_TYPE_NAME" Width="80"  />
                            <ext:Column ID="material_major" runat="server" Text="物料大类" DataIndex="MAJOR_TYPE_NAME" Width="80"  />
