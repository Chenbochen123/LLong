<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HppPlanReport_Cutting.aspx.cs" Inherits="Plugins_Semis_Reports_Cutting" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpFcheckInfo" runat="server" Layout="border">
            <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".2"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox runat="server" ID="cmbProcedure" Editable="false" FieldLabel="工序" LabelAlign="Right"></ext:ComboBox>
                                    </Items>
                                </ext:Container>
                            </Items>
                            <Listeners>
                ...
                <ext:Panel ID="pnlDetail" runat="server" Region="Center" Title="裁断计划报表" Height="250" Icon="Basket" Layout="Fit" Collapsible="true"
                        ...
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" IDProperty="OBJID">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="PART_NAME" />
                                                <ext:ModelField Name="DAJUAN" />
                            ...
                            <ColumnModel ID="ColumnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="partName" runat="server" Text="部件名称" DataIndex="PART_NAME" Width="60" />
                                    <ext:Column ID="daJuan" runat="server" Text="大卷" DataIndex="DAJUAN" Width="60" />
                                    <ext:Column ID="banChan" runat="server" Text="成型班产" DataIndex="BANCHAN" Width="60" />
                                    <ext:Column ID="danHao" runat="server" Text="单耗" DataIndex="DANHAO" Width="60" />
                                    <ext:Column ID="requirements" runat="server" Text="部件班需求量" DataIndex="REQUIREMENTS" Width="100" />
                                    <ext:Column ID="safeStocks" runat="server" Text="安全库存" DataIndex="SAFE_STOCKS" Width="60" />
                                    <ext:Column ID="shiftStocks" runat="server" Text="接班库存" DataIndex="SHIFT_STOCKS" Width="60" />
                                    ...
                                    <ext:Column ID="zhong" runat="server" Text="中班（16：00-24:00）">
                                        <Columns>
                                            ...
                                            <ext:Column ID="ZHONG_REASON" runat="server" Text="误产原因" DataIndex="ZHONG_REASON" Width="60">
                                            </ext:Column>
                                        </Columns>
                                    </ext:Column>
                                    <ext:Column ID="ye" runat="server" Text="夜班（00：00-08:00）">
                                        <Columns>
                                            ...
                                            <ext:Column ID="YE_REASON" runat="server" Text="误产原因" DataIndex="YE_REASON" Width="60">
                                            </ext:Column>
                                        </Columns>
                                    </ext:Column>
                                    <ext:Column ID="Column6" runat="server" Text="白班（08：00-16:00）">
                                        <Columns>
                                            ...
                                            <ext:Column ID="ZAO_REASON" runat="server" Text="误产原因" DataIndex="ZAO_REASON" Width="60">
                                            </ext:Column>
                                        </Columns>
                                    </ext:Column>
                                </Columns>
