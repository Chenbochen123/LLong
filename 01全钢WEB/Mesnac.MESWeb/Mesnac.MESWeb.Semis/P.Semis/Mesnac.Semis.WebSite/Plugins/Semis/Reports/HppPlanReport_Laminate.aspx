<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HppplanReport_Laminate.aspx.cs" Inherits="Plugins_Semis_Reports_Laminate" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpFcheckInfo" runat="server" Layout="border">
            <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".2"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox runat="server" ID="cmbEquip" Editable="false" FieldLabel="机台" LabelAlign="Right"></ext:ComboBox>
                                    </Items>
                                </ext:Container>
                            </Items>
                            <Listeners>
                ...
                <ext:Panel ID="pnlDetail" runat="server" Region="Center" Title="复合计划报表" Height="250" Icon="Basket" Layout="Fit" Collapsible="true"
                        ...
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="partName" runat="server" Text="部件名称" DataIndex="MINOR_TYPE_NAME" Width="60" />
                                    ...
                                    <ext:Column ID="requirements" runat="server" Text="单班耗用" DataIndex="REQUIREMENTS" Width="100" />
                                    ...
                                    <ext:Column ID="PLAN_AMOUNT" runat="server" Text="计划产量" DataIndex="PLAN_AMOUNT" Width="60">
                                    </ext:Column>
