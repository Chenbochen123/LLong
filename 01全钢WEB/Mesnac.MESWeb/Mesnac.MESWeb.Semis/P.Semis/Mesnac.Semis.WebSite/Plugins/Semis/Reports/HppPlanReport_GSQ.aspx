<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HppPlanReport_GSQ.aspx.cs" Inherits="Plugins_Semis_Reports_GSQ" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpFcheckInfo" runat="server" Layout="border">
            <Items>
                ...
                <ext:Panel ID="pnlDetail" runat="server" Region="Center" Title="钢丝圈计划报表" Height="250" Icon="Basket" Layout="Fit" Collapsible="true"
                            ...
                            <ColumnModel ID="ColumnModel" runat="server">
                                <Columns>
                                    <ext:RowNumbererColumn ID="rowNumCol1" runat="server" Width="35" />
                                      <ext:Column ID="equipName" runat="server" Text="机台" DataIndex="EQUIP_NAME" Width="180" />
