<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HppPlanReport_Underlayer.aspx.cs" Inherits="Plugins_Semis_Reports_Underlayer" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpFcheckInfo" runat="server" Layout="border">
            <Items>
                ...
                <ext:Panel ID="pnlDetail" runat="server" Region="Center" Title="内衬层计划报表" Height="250" Icon="Basket" Layout="Fit" Collapsible="true"
                        ...
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="banChan" runat="server" Text="成型需求量" DataIndex="BANCHAN" Width="60" />
                                    <ext:Column ID="danHao" runat="server" Text="单耗" DataIndex="DANHAO" Width="60" />
                                    <ext:Column ID="requirements" runat="server" Text="班需求量" DataIndex="REQUIREMENTS" Width="100" />
