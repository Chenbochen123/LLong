<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductionStat.aspx.cs" Inherits="Plugins_Semis_Production_ProductionInfoStat" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //-------机台-----查询带回弹出框--BEGIN
        var McUI_SearchBox_SearchBoxHbeSemisEquip_Window_Creat = function (minorTypeId) {
            Ext.create("Ext.window.Window", {//查询带回窗体
                id: "McUI_SearchBox_SearchBoxHbeSemisEquip_Window",
                height: 460,
                hidden: true,
                width: 560,
                html: "<iframe src='" + thisRootUrl + "McUI/SearchBox/SearchBoxHbeSemisEquip.aspx?MINOR_TYPE_ID=" + minorTypeId + "' width=100% height=100% scrolling=no  frameborder=0></iframe>",
        ...
        var tgrSearchEquipName_Click = function (item, trigger, index) {//机台查询
            if (index == 0) {
                item.setValue('');
                ...
                McUI_SearchBox_SearchBoxHbeSemisEquip_Window_Creat(minorTypeId);
                App.McUI_SearchBox_SearchBoxHbeSemisEquip_Window.show();
            }
        }

        var McUI_SearchBox_SearchBoxHbeSemisEquip_Request = function (record) {
        ...
        var tgrSearchMaterialName_Click = function (item, trigger, index) {//半制品规格查询
            if (index == 0) {
                item.setValue('');
