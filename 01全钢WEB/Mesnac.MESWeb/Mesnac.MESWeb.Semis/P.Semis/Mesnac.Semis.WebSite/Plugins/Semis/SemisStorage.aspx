<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SemisStorage.aspx.cs" Inherits="Plugins_Semis_SemisStorage" %>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MATERIALNAME" runat="server" Text="规格" DataIndex="MATERIAL_NAME" Width="250" />
                                     <ext:Column ID="SAP_CODE" runat="server" Text="SAP号" DataIndex="SAP_CODE" Width="120" />
                                    ...
                                    <ext:Column ID="LR_FLAG" runat="server" Text="左右标志" DataIndex="LR_FLAG" Width="80" />
                                    <ext:Column ID="PROD_CODE" runat="server" Text="项目代码" DataIndex="PROD_CODE" Width="120" Hidden="true"/>
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            <Store>
                                <ext:Store ID="storeDetail" runat="server" PageSize="10" OnReadData="storeDetail_ReadData">
                                    ...
                                    <Parameters>
                                        ...
                                        <ext:StoreParameter Name="LR_FLAG" Mode="Raw" Value="#{pnlList}.getSelectionModel().hasSelection() ? #{pnlList}.getSelectionModel().getSelection()[0].data.LR_FLAG : -1" />
                                    </Parameters>
                                </ext:Store>
                            </Store>
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column2" runat="server" Text="项目代码" DataIndex="PROD_CODE" Flex="1"  Hidden="true">
                                     <Renderer Fn="Barcode_Renderer" />
                                    </ext:Column>
                                    ...
                                    <ext:Column ID="Column3" runat="server" Text="左右标志" DataIndex="LR_FLAG" Flex="1" >
                                    <Renderer Fn="Barcode_Renderer" />
                                    </ext:Column>
