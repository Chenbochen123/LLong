<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HppKouMould.aspx.cs" Inherits="Plugins_Semis_HppKouMould" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_editdefect = function (record) {
            ...
            var Rfid = record.data.RFID;
            var KouMould = record.data.KOU_MOULD;
            //rec DefectPos
            var defectPos = record.data.REASON_CODE;
            App.direct.commandcolumn_direct_editdefect(ObjID, Rfid, KouMould, {
    ...
    <ext:Viewport ID="vpDefect" runat="server" Layout="border">
        <Items>
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true"
                        ...
                        <Items>
                             <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                      <ext:TextField ID="textrfid" runat="server" FieldLabel="RFID" MaxLength="100"
                                        LabelAlign="Right" />
                                </Items>
                            </ext:Container>
                             <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                      <ext:TextField ID="textkou" runat="server" FieldLabel="口型板信息" MaxLength="100"
                                        LabelAlign="Right" />
                                </Items>
                            </ext:Container>
                        </Items>
            ...
            <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5 "
                            ...
                            <Columns>
                                <ext:RowNumbererColumn ID="rowNumCol1" runat="server" Width="35" />
                                 <ext:Column ID="DefectCode" runat="server" Text="编码" DataIndex="OBJID" Width="60"   Visible="false" />
                                    <ext:Column ID="Column1" runat="server" Text="RFID" DataIndex="RFID" Width="260" />
                                <ext:Column ID="DefectName" runat="server" Text="口型板信息" DataIndex="KOU_MOULD" Width="260" />
                                <ext:Column ID="Remark" runat="server" Text="操作人" DataIndex="USER_NAME" Width="260" />
              ...
              <ext:Window ID="winAddDefect" runat="server" Icon="MonitorAdd" Closable="true" Title="添加信息"
                            ...
                            <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                <Items>
                                    <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        Padding="5">
                                        <Items>
                                                   <ext:TextField ID="txtaddRFID" runat="server" FieldLabel="RFID" MaxLength="100"
                                                LabelAlign="Right"  AllowBlank="false" >
                                            </ext:TextField>
                                            <ext:TextField ID="txtaddKOU" runat="server" FieldLabel="口型板" MaxLength="100"
                                                LabelAlign="Right" AllowBlank="false" >
                                            </ext:TextField>
                                        </Items>
                                    </ext:Container>
            ...
            <ext:Window ID="winModifyDefect" runat="server" Icon="MonitorEdit" Closable="false"
                Title="修改信息" Width="320" Height="250" Resizable="false" Hidden="true" Modal="false"
                                        ...
                                        <Items>
                                            <ext:TextField ID="modify_objID" Hidden="true" runat="server" LabelAlign="Left"
                                                FieldLabel="ID">
                                                   ...
                                                   <ext:TextField ID="txtmodifyRFID" runat="server" FieldLabel="RFID" MaxLength="100"
                                                LabelAlign="Right"  AllowBlank="false" >
                                            </ext:TextField>
                                            <ext:TextField ID="txtmodofyKOU" runat="server" FieldLabel="口型板" MaxLength="100"
                                                LabelAlign="Right" AllowBlank="false" >
                                            </ext:TextField>
                                        </Items>
                                    </ext:Container>
