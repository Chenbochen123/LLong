<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SemisTechGsqNew.aspx.cs" Inherits="Plugins_Semis_Technology_SemisTechGsqNew" %>
...
<head runat="server">
    ...
    <script>
        ...
        var refreshData5 = function (data) {
            ...
            App.SemisTechNcc.getBody().update("<iframe src='SemisTechGsqMuch.html' width=100% height=100% scrolling=no  frameborder=0></iframe>");
        }
    </script>
</head>
                        ...
                        <ext:Panel runat="server" Width="1200" Border="false">
                            <Items>
                                <ext:FieldSet runat="server" Layout="ColumnLayout" ColumnWidth="1" Title="曲线">
                                    <Items>
                                        <ext:ComboBox ID="cbxequip" runat="server"  LabelAlign="left" EmptyText="机台"
                                            Editable="false">
                                            <Items>
