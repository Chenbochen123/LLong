<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RimInOutRecord.aspx.cs" Inherits="Plugins_Semis_Rim_RimInOutRecord" %>
                            ...
                            <Items>
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                    ...
                                    <Items>
                                      ...
                                      <ext:ComboBox ID="cbxplace" runat="server" FieldLabel="原库位" LabelAlign="Right" Editable="false"/>
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                    ...
                                    <Items>
                                      ...
                                      <ext:ComboBox ID="cbxnewplace" runat="server" FieldLabel="目的库位" LabelAlign="Right" Editable="false"/>
                                    </Items>
                                </ext:Container>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column2" runat="server" Text="轮辋类型" DataIndex="LW_TYPE" Width="100" />
                                    <ext:Column ID="Column7" runat="server" Text="SAP号" DataIndex="MATER_SAP" Width="100" />
                                    <ext:Column ID="Column8" runat="server" Text="物料规格" DataIndex="MATERIAL_NAME" Width="160" />
                                    <ext:Column ID="Column4" runat="server" Text="段差" DataIndex="DC" Width="100" />
                                    <ext:Column ID="Remark" runat="server" Text="寸口" DataIndex="CK" Width="100" />
                                    <ext:Column ID="Column3" runat="server" Text="出入库类型" DataIndex="TYPE" Width="100" />
                                    <ext:Column ID="DefectName" runat="server" Text="原库位" DataIndex="OLD_PLACE" Width="100" />
                                    <ext:Column ID="Column5" runat="server" Text="目的库位" DataIndex="NEW_PLACE" Width="100" />
                                    <ext:Column ID="Column6" runat="server" Text="操作人" DataIndex="USER_NAME" Width="100" />
