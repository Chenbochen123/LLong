<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RimRepair.aspx.cs" Inherits="Plugins_Semis_Rim_RimRepair" %>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" IDProperty="OBJID">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="BEGIN_USER" />
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column2" runat="server" Text="维修项目" DataIndex="ITEM" Width="150" />
                                    <ext:Column ID="Column4" runat="server" Text="维修厂家" DataIndex="FACTORY" Width="150" />
                                    <ext:Column ID="Column7" runat="server" Text="开始维修人" DataIndex="BEGIN_USER" Width="100" />
                                    <ext:DateColumn ID="Column9" runat="server" Text="维修开始时间" DataIndex="BEGIN_TIME" Width="160" Format="yyyy-MM-dd HH:mm:ss"/>
                                    <ext:Column ID="Column8" runat="server" Text="结束维修人" DataIndex="END_USER" Width="160" />
                                    <ext:DateColumn ID="DateColumn1" runat="server" Text="维修结束时间" DataIndex="END_TIME" Width="160" Format="yyyy-MM-dd HH:mm:ss"/>
