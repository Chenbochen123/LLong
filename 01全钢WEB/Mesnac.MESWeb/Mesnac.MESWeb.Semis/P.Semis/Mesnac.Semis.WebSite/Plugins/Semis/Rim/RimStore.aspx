<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RimStore.aspx.cs" Inherits="Plugins_Semis_Rim_RimStore" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_editdefect = function (record) {
            ...
            var code = record.data.STORE_CODE;
            var name = record.data.STORE_NAME;
            var num = record.data.NUM;
            var remark = record.data.REMARK;
            App.direct.commandcolumn_direct_editdefect(ObjID, code, name,num,remark, {
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpDefect" runat="server" Layout="border">
            <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true"
                            ...
                            <Items>
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                    Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtstoreCode" runat="server" FieldLabel="库区编码" LabelAlign="Right" Editable="false"/>
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                    Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtstoreName" runat="server" FieldLabel="库区名称" LabelAlign="Right" Editable="false"/>
                                    </Items>
                                </ext:Container>
                            </Items>
                        </ext:FormPanel>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column1" runat="server" Text="库区编码" DataIndex="STORE_CODE" Width="100" />
                                    <ext:Column ID="DefectName" runat="server" Text="库区名称" DataIndex="STORE_NAME" Width="160" />
                ...
                <ext:Window ID="winAddDefect" runat="server" Icon="MonitorAdd" Closable="true" Title="添加库区信息"
                                ...
                                <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txtCode" runat="server" FieldLabel="库区编码" LabelAlign="Right" />
                                                <ext:TextField ID="txtName" runat="server" FieldLabel="库区名称" LabelAlign="Right" />
                                                <ext:TextField ID="txtNum" runat="server" FieldLabel="容量" LabelAlign="Right" />
                                ...
                                <ext:Container ID="Container5" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="Container6" runat="server" Layout="FormLayout" ColumnWidth="1"
                                            Padding="2">
                                            <Items>
                                                <ext:TextField ID="ed_code" runat="server" FieldLabel="库区编码" LabelAlign="Right" />
                                                <ext:TextField ID="ed_name" runat="server" FieldLabel="库区名称" LabelAlign="Right" />
