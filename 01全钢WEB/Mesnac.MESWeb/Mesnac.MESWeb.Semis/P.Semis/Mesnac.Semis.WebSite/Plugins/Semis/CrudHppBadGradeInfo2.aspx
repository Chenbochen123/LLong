<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrudHppBadGradeInfo2.aspx.cs" Inherits="Plugins_Semis_CrudHppBadGradeInfo2" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpMoldingStorage" runat="server" Layout="border">
            <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                    Padding="5">
                                    <Items>
                                      <ext:TextField ID="txtName" runat="server" FieldLabel="原因名称" LabelAlign="Right" Editable="false">
                                        </ext:TextField>
                                    </Items>
                                </ext:Container>
                            </Items>
                ...
                <ext:Panel ID="pnlDetail" runat="server"  Title="不合格原因" Height="500" Region="Center" Frame="true" Layout="Fit"  MarginsSummary="0 5 5 5">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="NAME" runat="server" Text="原因名称" DataIndex="NAME" Width="250" />
              ...
              <ext:Window ID="winAddTooling" runat="server" Icon="MonitorAdd" Closable="true" Title="添加不合格处理原因"
                            ...
                            <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                <Items>
                                    <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        Padding="5">
                                        <Items>
                                             <ext:TextField ID="txtAddName" runat="server" FieldLabel="原因名称" LabelAlign="Left"
                                ...
                                <Items>
                                    <ext:Container ID="Container6" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        ...
                                        <Items>
                                            ...
                                            <ext:TextField ID="txtUpName" runat="server" FieldLabel="原因名称" LabelAlign="Left"
                                                ReadOnly="false" Enabled="true" />
