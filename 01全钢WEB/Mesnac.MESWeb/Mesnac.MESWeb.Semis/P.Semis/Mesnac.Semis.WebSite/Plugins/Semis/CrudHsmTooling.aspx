<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrudHsmTooling.aspx.cs" Inherits="Plugins_Semis_CrudHsmTooling" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_editdefect = function (record) {
            var carNo = record.data.CARD_NO;
            var ToolingRFIDBarcode = record.data.TOOLING_RFID_BARCODE;
            var toolingType = record.data.TOOLING_TYPE;
            var remark = record.data.REMARK;
            App.direct.commandcolumn_direct_editdefect(carNo, ToolingRFIDBarcode, toolingType, remark, {
...
<%--        <asp:Button ID="btnExportSubmit" Style="display: none" runat="server" Text="Button"
        ...
        <ext:Viewport ID="vpMoldingStorage" runat="server" Layout="border">
            <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox ID="cbxToolingType" runat="server" FieldLabel="工装类型" LabelAlign="Right" Editable="false">
                                        </ext:ComboBox>
                                    </Items>
                                </ext:Container>
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                    Padding="5">
                                    <Items>
                                      <ext:TextField ID="txtCardNo" runat="server" FieldLabel="流水卡号" LabelAlign="Right" Editable="false">
                                        </ext:TextField>
                                    </Items>
                                </ext:Container>
                                ...
                                <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                    Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtToolingRfidBarcode" runat="server" FieldLabel="工装RFID条码" LabelAlign="Right" Editable="false">
                                        </ext:TextField>
                                    </Items>
                                </ext:Container>
                            </Items>
                ...
                <ext:Panel ID="pnlDetail" runat="server"  Title="工装信息" Height="500" Region="Center" Frame="true" Layout="Fit"  MarginsSummary="0 5 5 5">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="CARD_NO" runat="server" Text="流水卡号" DataIndex="CARD_NO" Width="250" />
                                    <ext:Column ID="TOOLING_RFID_BARCODE" runat="server" Text="工装RFID条码" DataIndex="TOOLING_RFID_BARCODE"  />
                                    <ext:Column ID="TOOLING_TYPE_NAME" runat="server" Text="工装类型名称" DataIndex="TOOLING_TYPE_NAME"  />
                                    <ext:Column ID="TOOLING_TYPE" runat="server" Text="工装类型" DataIndex="TOOLING_TYPE"  />
                                    <ext:Column ID="IS_USED" runat="server" Text="使用状态" DataIndex="IS_USED" Flex="1" />
                                    <ext:Column ID="RECORD_USER_NAME" runat="server" Text="记录人" DataIndex="RECORD_USER_NAME" Flex="1" />
              ...
              <ext:Window ID="winAddTooling" runat="server" Icon="MonitorAdd" Closable="true" Title="添加工装信息"
                            ...
                            <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                <Items>
                                    <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        Padding="5">
                                        <Items>
                                             <ext:TextField ID="txtAddCardNo" runat="server" FieldLabel="流水卡号" LabelAlign="Left"
                                                ReadOnly="false" Enabled="true" />
                                             <ext:TextField ID="txtAddToolingRfidBarcode" runat="server" FieldLabel="工装RFID条码" LabelAlign="Left"
                                                ReadOnly="false" Enabled="true" />
                                             <ext:ComboBox ID="cbxAddToolingType" runat="server" FieldLabel ="工装类型" LabelAlign="Left" 
                                              Editable="false"/>

                                             <ext:TextField ID="TextField6" runat="server" FieldLabel="备注" LabelAlign="Left"
                                                ReadOnly="false" Enabled="true" />
                                        </Items>
                                    </ext:Container>
                                </Items>
                                ...
                                <Items>
                                    <ext:Container ID="Container6" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        ...
                                        <Items>
                                            ...
                                            <ext:TextField ID="txtUpCardNo" runat="server" FieldLabel="流水卡号" LabelAlign="Left"
                                                ReadOnly="false" Enabled="true" />
                                             <ext:TextField ID="txtUpToolingRfidBarcode" runat="server" FieldLabel="工装RFID条码" LabelAlign="Left"
                                                ReadOnly="false" Enabled="true" />
                                            <ext:ComboBox ID="cbxUpToolingType" runat="server" FieldLabel ="工装类型" LabelAlign="Left" 
                                                ReadOnly="false" Enabled="true">
