<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TQShigong.aspx.cs" Inherits="Plugins_Semis_Shigong_TQShigong" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpMoldingStorage" runat="server" Layout="border">
            <Items>
                ...
                <ext:TabPanel runat="server" Region="Center" ID="panel1" Title="" Layout="Fit" Flex="3">
                    <Items>
                        <ext:Panel runat="server" Region="Center" ID="panelDetailInfo" Title="施工表" Layout="Fit" Flex="3">
                        ...
                        <ext:Panel runat="server" Region="Center" ID="panel2" Title="口型尺寸图" Layout="Fit" Flex="3">
                            <Loader runat="server" Mode="frame">
                            </Loader>
                            <Items>
                            </Items>
