<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wages_Plan.aspx.cs" Inherits="Plugins_Semis_Wages_Wages_Plan" %>
    ...
    <ext:ResourceManager runat="server"/>
        <ext:Viewport ID="vpMoldingStorage" runat="server" Layout="border">
            <Items>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="tbMoldingStorage">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="Delete" Text="批量删除" ID="btnDel">
                                    <DirectEvents>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtMatersap" runat="server" FieldLabel="物料SAP" LabelAlign="Right" Editable="false">
                                        </ext:TextField>
                                    </Items>
                                </ext:Container>
                                ...
                                <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtStandard" runat="server" FieldLabel="定额标准" LabelAlign="Right" Editable="false">
                                        </ext:TextField>
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox ID="cbxMatermin" runat="server" FieldLabel="物料细类" LabelAlign="Right" Editable="false">
                                        </ext:ComboBox>
                                    </Items>
                                </ext:Container>
                            </Items>
                ...
                <ext:Panel ID="pnlDetail" runat="server" Title="定额计划信息" Height="500" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 5 5">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="STANDARD_WAGES" runat="server" Text="型号" DataIndex="MATERIAL_TYPE" Flex="1" />
                                    <ext:Column ID="Column1" runat="server" Text="定额标准" DataIndex="STANDARD_INFO" Flex="1" />
                ...
                <ext:Window ID="winAddTooling" runat="server" Icon="MonitorAdd" Closable="true" Title="添加定额计划信息"
                                        ...
                                        <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                            ...
                                            <Items>
                                                ...
                                                <ext:TextField ID="addMatersap" runat="server" FieldLabel="物料SAP" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="addMaterType" runat="server" FieldLabel="型号" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="addStandard" runat="server" FieldLabel="定额标准" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                ...
                <ext:Window ID="winUpdateDefect" runat="server" Icon="MonitorEdit" Closable="false"
                    Title="修改定额计划信息" Width="320" Height="340" Resizable="false" Hidden="true" Modal="false"
                                        ...
                                        <ext:Container ID="Container6" runat="server" Layout="FormLayout" ColumnWidth="1"
                                            ...
                                            <Items>
                                                ...
                                                <ext:TextField ID="editEquipName" runat="server" FieldLabel="产线" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="editMatersap" runat="server" FieldLabel="物料SAP" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="editmaterType" runat="server" FieldLabel="型号" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="editStandard" runat="server" FieldLabel="定额标准" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
