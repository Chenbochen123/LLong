<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wages_Clean.aspx.cs" Inherits="Plugins_Semis_Wages_Wages_Clean" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vpMoldingStorage" runat="server" Layout="border">
            <Items>
                            ...
                            <Items>
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    ...
                                    <Items>
                                        ...
                                        <ext:ComboBox ID="cbxcls" runat="server" FieldLabel="班组" LabelAlign="Right"
                                            Editable="false">
                                            <Items>
                                ...
                                <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtUsername" runat="server" FieldLabel="清理人" LabelAlign="Right" Editable="false">
                                        </ext:TextField>
                                    </Items>
                                </ext:Container>
                                ...
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox ID="cbxreason" runat="server" FieldLabel="原因" LabelAlign="Right" Editable="false">
                                        </ext:ComboBox>
                                    </Items>
                                </ext:Container>
                            </Items>
                ...
                <ext:Panel ID="pnlDetail" runat="server" Title="清理耗时信息" Height="500" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 5 5">
                    <Items>
                        <ext:GridPanel ID="pnlList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:DateColumn ID="DateColumn1" runat="server" Text="清理日期" DataIndex="CLEAN_DATE" Flex="1" Format="yyyy-MM-dd" />
                                    <ext:Column ID="TOOLING_RFID_BARCODE" runat="server" Text="清理人员" DataIndex="CLEAN_USER" />
                                    <ext:Column ID="TOOLING_TYPE_NAME" runat="server" Text="产线" DataIndex="EQUIP_NAME" />
                                    <ext:Column ID="TOOLING_TYPE" runat="server" Text="班组" DataIndex="SHIFT" />
                                    <ext:Column ID="IS_USED" runat="server" Text="清理次数" DataIndex="CLEAN_COUNT" Flex="1" />
                                    <ext:Column ID="STANDARD_WAGES" runat="server" Text="清理耗时（分钟/次）" DataIndex="CLEAN_TIME" Flex="1" />
                                    <ext:Column ID="Column1" runat="server" Text="原因" DataIndex="REASON" Flex="1" />
                                    <ext:Column ID="Column2" runat="server" Text="个人耗时总计" DataIndex="TOTALUSER" Flex="1" />
                                    <ext:Column ID="Column5" runat="server" Text="产线耗时总计" DataIndex="TOTALEQUIP" Flex="1" />
                ...
                <ext:Window ID="winAddTooling" runat="server" Icon="MonitorAdd" Closable="true" Title="添加清理耗时信息"
                                ...
                                <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                            Padding="5">
                                            <Items>
                                                <ext:DateField ID="addCleandate" runat="server" FieldLabel="清理日期" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="addcleanuser" runat="server" FieldLabel="清理人" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                ...
                                                <ext:TextField ID="addCleancount" runat="server" FieldLabel="清理次数" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="addCleantime" runat="server" FieldLabel="清理耗时(分钟/次)" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="addReason" runat="server" FieldLabel="原因" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                ...
                <ext:Window ID="winUpdateDefect" runat="server" Icon="MonitorEdit" Closable="false"
                    Title="修改清理耗时信息" Width="320" Height="340" Resizable="false" Hidden="true" Modal="false"
                                    ...
                                    <Items>
                                        <ext:Container ID="Container6" runat="server" Layout="FormLayout" ColumnWidth="1"
                                            ...
                                            <Items>
                                                ...
                                                <ext:DateField ID="editcleandate" runat="server" FieldLabel="清理日期" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="editcleanuser" runat="server" FieldLabel="清理人" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="editequipname" runat="server" FieldLabel="产线" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:ComboBox ID="class22" runat="server" FieldLabel="班组" LabelAlign="left"
                                                    Editable="false">
                                                    <Items>
                                                        <ext:ListItem Text="甲" Value="甲">
                                                        </ext:ListItem>
                                                ...
                                                <ext:TextField ID="editCleanCount" runat="server" FieldLabel="清理次数" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="editCleanTime" runat="server" FieldLabel="清理耗时(分钟/次)" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
                                                <ext:TextField ID="editReason" runat="server" FieldLabel="原因" LabelAlign="Left"
                                                    ReadOnly="false" Enabled="true" />
