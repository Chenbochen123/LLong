<%@ page language="C#" autoeventwireup="true" inherits="McUI_Crud, Mesnac.Main.WebSite" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="viewport" runat="server" Layout="BorderLayout">
            <Items>
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Layout="FitLayout" Modal="true"
                ...
                <ext:Window ID="winUpdate" runat="server" Icon="MonitorEdit" Closable="false" Layout="FitLayout" Modal="true">
                    <Items>
