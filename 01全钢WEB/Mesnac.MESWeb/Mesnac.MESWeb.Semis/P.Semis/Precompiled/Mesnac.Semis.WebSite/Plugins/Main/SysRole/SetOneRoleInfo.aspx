<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Main_SysRole_SetOneRoleInfo, Mesnac.Main.WebSite" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        Ext.create("Ext.window.Window", {
            ...
            hidden: true,
            width: 360,
            html: "<iframe src='/MCUI/SearchBox/SearchBoxSspRole.aspx' width=100% height=100% scrolling=no  frameborder=0></iframe>",
