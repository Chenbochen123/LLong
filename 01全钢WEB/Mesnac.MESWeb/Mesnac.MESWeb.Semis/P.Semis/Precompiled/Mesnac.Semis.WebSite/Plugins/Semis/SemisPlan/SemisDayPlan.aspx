<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Semis_SemisPlan_SemisDayPlan, Mesnac.Semis.WebSite" %>
                        ...
                        <Columns>
                            ...
                            <ext:Column runat="server" Text="工序" DataIndex="procedure" Width="60" Hidden="false" />
                             <ext:Column runat="server" Text="生产工艺" Hidden="false">
                                <Columns>
                                    <ext:Column runat="server" Text="BOM版本" DataIndex="bom" Width="160" Hidden="false" />
