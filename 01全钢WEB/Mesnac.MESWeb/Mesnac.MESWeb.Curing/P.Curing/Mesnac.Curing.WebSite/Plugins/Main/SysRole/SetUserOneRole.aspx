<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Main_SysRole_SetUserOneRole, Mesnac.Main.WebSite" %>
                ...
                <ext:Panel ID="Panel4" runat="server" Region="Center" AutoHeight="true" Layout="BorderLayout">
                    ...
                    <Items>
                        <ext:TreePanel ID="TreePanel1" runat="server" Flex="3" Region="West" Collapsible="false" RootVisible="false" MultiSelect="true"
                            ...
                            <ColumnModel>
                                <Columns>
                                    <ext:TreeColumn ID="DepName" DataIndex="DeptName" runat="server" Sortable="false" Hideable="false" Text="部门名称" Width="200" />
                        ...
                        <ext:GridPanel ID="GridPanel1" runat="server" Flex="2" Region="Center" Collapsible="false" MultiSelect="true" FolderSort="true"
                            ...
                            <Store>
                                <ext:Store ID="store" runat="server">
                                    ...
                                    <Model>
                                        <ext:Model ID="model3" runat="server" IDProperty="EquipCode">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="Remark" />
                                                <ext:ModelField Name="IsEmployee" />
                                            </Fields>
                                        </ext:Model>
                                    </Model>
                                    <Listeners>
                                    ...
                                    <Sorters>
                                        <ext:DataSorter Property="IsEmployee" Direction="ASC" />
                                    </Sorters>
                                </ext:Store>
                            </Store>
                            <ColumnModel ID="columnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="UserRemark" DataIndex="Remark" runat="server" Text="备注" Flex="1" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
