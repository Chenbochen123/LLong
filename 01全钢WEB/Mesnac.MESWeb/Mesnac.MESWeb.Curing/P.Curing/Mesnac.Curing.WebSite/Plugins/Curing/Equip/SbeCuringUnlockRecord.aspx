<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SbeCuringUnlockRecord.aspx.cs" Inherits="Plugins_Curing_Equip_SbeCuringUnlockRecord" %>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true"
                            ...
                            <Items>
                                ...
                                <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                    Padding="5">
                                    <Items>
                                        <ext:ComboBox ID="cbxtype" runat="server" FieldLabel="类型" LabelAlign="left"
                                            Editable="false">
                                            <Items>
                                                <ext:ListItem Text="累计报警" Value="累计报警">
                                                </ext:ListItem>
                                                <ext:ListItem Text="硫化降级" Value="硫化降级">
                                                </ext:ListItem>
                                            </Items>
                                            <Triggers>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="NAME1" runat="server" Text="解锁人" DataIndex="USER_NAME" Width="120" />
                                    <ext:DateColumn ID="RECORD_TIME" runat="server" Text="解锁时间" DataIndex="RECORD_TIME" Width="160" Format="yyyy-MM-dd HH:mm:ss" />
                                    <ext:Column ID="Column2" runat="server" Text="类型" DataIndex="REMARK" Width="120" />
                                </Columns>
                            </ColumnModel>
                            <BottomBar>
