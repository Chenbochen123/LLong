<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterChangeUnlockRecord.aspx.cs" Inherits="Plugins_Curing_Equip_MaterChangeUnlockRecord" %>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                                ...
                                <Model>
                                    <ext:Model ID="model" runat="server" IDProperty="OBJID">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="NAME1" />
                                            <ext:ModelField Name="NAME2" />
                                            <ext:ModelField Name="NAME3" />
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="NAME1" runat="server" Text="工艺检查员" DataIndex="NAME1" Width="120" />
                                <ext:Column ID="NAME2" runat="server" Text="生产班长" DataIndex="NAME2" Width="120"/>
                                <ext:Column ID="NAME3" runat="server" Text="保全班" DataIndex="NAME3" Width="120" />
                                <ext:DateColumn ID="RECORD_TIME" runat="server" Text="解锁时间" DataIndex="RECORD_TIME" Width="160" Format="yyyy-MM-dd HH:mm:ss"/>
                            </Columns>
                        </ColumnModel>
                        <BottomBar>
