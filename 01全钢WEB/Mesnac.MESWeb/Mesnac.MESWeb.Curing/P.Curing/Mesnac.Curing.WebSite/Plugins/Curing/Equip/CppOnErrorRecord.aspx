<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CppOnErrorRecord.aspx.cs" Inherits="Plugins_Curing_Equip_CppOnErrorRecord" %>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="EQUIP_NAME" runat="server" Text="机台名称" DataIndex="EQUIP_ID" Width="160" />
                                <ext:Column ID="SHOW_NAME" runat="server" Text="停机时间" DataIndex="ON_TIME" Width="120"/>
                                <ext:Column ID="Column1" runat="server" Text="停机原因" DataIndex="STOP_REASON" Width="120"/>
                                <ext:Column ID="Column2" runat="server" Text="物料名称" DataIndex="MATER_ID" Width="160" Hidden ="true"/>
                                <ext:Column ID="Column3" runat="server" Text="记录人" DataIndex="USER_NAME" Width="120"/>
