<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WashMouldYJ.aspx.cs" Inherits="Plugins_Curing_Equip_WashMouldYJ" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var Barcode_Renderer = function (value, metadata, record, rowIndex, colIndex, store, view) {
            if (record.data.USECOUNT >= 240 && record.data.IN_TYPE == "普通模具") {
                metadata.style = "color: red;";
            }
            else if (record.data.USECOUNT >= 160 && record.data.IN_TYPE == "弹簧模具") {
                metadata.style = "color: red;";
            }
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true"
                        ...
                        <Items>
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                Padding="5">
                                <Items>
                                    <ext:TextField ID="txtEquipName" runat="server" FieldLabel="机台名称" LabelAlign="Left" EmptyText="普通次数>=240次预警，弹簧次数>=160次预警">
                                    </ext:TextField>
                                </Items>
                            </ext:Container>
                        </Items>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                                ...
                                <Model>
                                    <ext:Model ID="model" runat="server" IDProperty="OBJID">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="LAST_TIME" Type="Date"/>
                                            <ext:ModelField Name="USECOUNT"/>
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <Renderer Fn="Barcode_Renderer" /></ext:Column>
                                <ext:DateColumn ID="LAST_TIME" runat="server" Text="上一次洗模时间" DataIndex="LAST_TIME" Width="160"  Format="yyyy-MM-dd HH:mm:ss"/>
                                <ext:Column ID="LEFT_DAY" runat="server" Text="累计次数" DataIndex="USECOUNT" Width="120"/>
                            </Columns>
                        </ColumnModel>
                        <BottomBar>
