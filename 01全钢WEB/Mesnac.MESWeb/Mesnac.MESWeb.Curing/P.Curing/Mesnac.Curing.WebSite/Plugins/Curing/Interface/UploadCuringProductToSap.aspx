<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadCuringProductToSap.aspx.cs" Inherits="Plugins_Curing_Interface_UploadCuringProductToSap" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var on_edit_bom_version_change = function (sender) {//物料返回值处理
            App.direct.on_edit_bom_version_change(sender.getValue());
        }
    </script>
</head>
<body>
                    ...
                    <Items>
                        <ext:FormPanel ID="FormPanel2" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:ComboBox ID="txt_edit_bom_version" runat="server" FieldLabel="BOM版本" LabelAlign="Right" Editable="false"
                                    ValueField="value" DisplayField="text" Hidden="false">
                                    <Store>
                                        <ext:Store ID="edit_bom_version_store" runat="server">
                                            <Model>
                                    ...
                                    <Listeners>
                                        <Change Fn="on_edit_bom_version_change" />
                                    </Listeners>
                                </ext:ComboBox>
                                <ext:Hidden ID="hidden_edit_bom_version" runat="server" />
                                <ext:Hidden ID="hidden_update_bom_version" runat="server" />
