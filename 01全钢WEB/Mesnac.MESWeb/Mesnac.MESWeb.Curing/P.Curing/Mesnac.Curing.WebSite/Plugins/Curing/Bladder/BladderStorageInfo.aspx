<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BladderStorageInfo.aspx.cs" Inherits="Plugins_Curing_Bladder_BladderStorageInfo" %>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" IDProperty="OBJID">                                            
                                            <Fields>                                                
                                                ...
                                                <ext:ModelField Name="IN_COUNT" />
                                                <ext:ModelField Name="OUT_COUNT" />
                                            </Fields>
                                        </ext:Model>
                                    </Model>
                                </ext:Store>
                            ...
                            <ColumnModel ID="colModel" runat="server">                              
                                <Columns>
                                    ...
                                    <ext:Column ID="IN_COUNT" runat="server" Text="库存数量" DataIndex="IN_COUNT" Width="160" />
                                    <ext:Column ID="OUT_COUNT" runat="server" Text="出库数量" DataIndex="OUT_COUNT" Width="160" />
                                    <%--<ext:Column ID="BLADDER_BATCH" runat="server" Text="批次" DataIndex="BLADDER_BATCH" Width="60"  />
                                    <ext:Column ID="FACTORY" runat="server" Text="厂家" DataIndex="FACTORY" Width="60"  />
                                    <ext:Column ID="DUMMY1" runat="server" Text="使用次数" DataIndex="DUMMY1" Width="80"  />
                                    <ext:Column ID="STATE" runat="server" Text="状态" DataIndex="STATE" Width="80"  />--%>
