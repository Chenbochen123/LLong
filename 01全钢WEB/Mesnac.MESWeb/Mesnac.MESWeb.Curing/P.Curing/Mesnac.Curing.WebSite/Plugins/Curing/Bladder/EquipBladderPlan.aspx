<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipBladderPlan.aspx.cs" Inherits="Plugins_Curing_Bladder_EquipBladderPlan" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var InsertBladderPlan = function (id) {
            Ext.Msg.confirm("提示", '所选胶囊为已出库胶囊,使用次数:' + id + ",确认要添加计划吗？", function (btn) { InsertBladderPlan_direct(btn) });
            return false;
        }
        var InsertBladderPlan_direct = function (btn) {
            if (btn != "yes") {
                return;
            }
            App.direct.InsertBladderPlan( {
                success: function (result) {
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        ...
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:DateField ID="txt_end_date" runat="server" FieldLabel="结束日期" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" Text="左右胶囊" DataIndex="EQUIP_POSITION_NAME" Width="60" />
                            <ext:DateColumn runat="server" Text="计划日期" DataIndex="PLAN_DATE" Width="80" Format="yyyy-MM-dd" />
                            <ext:Column runat="server" Text="物料名称" DataIndex="TYPE_NAME" Width="200" />
                            <ext:Column runat="server" Text="物料编号" DataIndex="MATERIAL_SAP_CODE" Width="100" />
                            <ext:Column runat="server" Text="胶囊编号" DataIndex="MOULD_ID" Width="120" />
                            <ext:Column runat="server" Text="创建人" DataIndex="USER_NAME" Width="100" />
                                    ...
                                    <Items>
                                        <ext:Container runat="server" Layout="FormLayout" Padding="5">
                                            <Items>
                                                ...
                                                <ext:ComboBox ID="add_cbxBladderSpec" runat="server" FieldLabel="胶囊规格" LabelAlign="right" Editable="false" />
                                                <ext:TextField ID="add_txtBladderCode"  FieldLabel="胶囊编号" 
