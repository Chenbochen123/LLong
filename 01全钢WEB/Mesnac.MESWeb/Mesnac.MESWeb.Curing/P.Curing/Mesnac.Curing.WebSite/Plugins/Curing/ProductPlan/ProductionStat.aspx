                                            ...
                                            <Items>
                                                ...
                                                <ext:FieldSet runat="server" Title="查询条件" Layout="ColumnLayout">
                                                    <Items>
                                                        ...
                                                        <ext:Container runat="server" Layout="ColumnLayout" ColumnWidth="1">
                                                            <Items>
                                                                <ext:ComboBox runat="server" ID="cboSearchEquipMajorTypeId" FieldLabel="设备类型" LabelAlign="Right" Hidden="true" Padding="2">
                                                                </ext:ComboBox>
                                                        ...
                                                        <ext:Container runat="server" Layout="ColumnLayout" ColumnWidth="1">
                                                            <Items>
                                                                <ext:ComboBox runat="server" ID="cboSearchSizeId" FieldLabel="规格" LabelAlign="Right" Width="300" LabelWidth="100" InputWidth="120" ColumnWidth="0.5" Padding="2">
                                                                    <Triggers>
                                                                        <ext:FieldTrigger Icon="Clear" Qtip="清空" />
                                                                    </Triggers>
                                                                    <Listeners>
                                                                ...
                                                                <ext:ComboBox runat="server" ID="cboSearchPlyratingId" FieldLabel="层级" LabelAlign="Right" Width="300" LabelWidth="100" InputWidth="120" ColumnWidth="0.5" Padding="2">
                                                                    <Triggers>
                                                                        <ext:FieldTrigger Icon="Clear" Qtip="清空" />
                                                                    </Triggers>
                                                                    <Listeners>
                                                                ...
                                                                <ext:ComboBox runat="server" ID="cboSearchPatternId" FieldLabel="花纹" LabelAlign="Right" Width="300" LabelWidth="100" InputWidth="120" ColumnWidth="0.5" Padding="2">
                                                                    <Triggers>
                                                                        <ext:FieldTrigger Icon="Clear" Qtip="清空" />
                                                                    </Triggers>
                                                                    <Listeners>
                                                                ...
                                                                <ext:ComboBox runat="server" ID="cboSearchBrandId" FieldLabel="品牌" LabelAlign="Right" Width="300" LabelWidth="100" InputWidth="120" ColumnWidth="0.5" Padding="2">
                                                                    <Triggers>
                                                                        <ext:FieldTrigger Icon="Clear" Qtip="清空" />
                                                                    </Triggers>
                                                                    <Listeners>
                                                                ...
                                                                <ext:TriggerField runat="server" ID="tgrSearchMaterialName" FieldLabel="成品胎规格" LabelAlign="Right" LabelWidth="100" InputWidth="420" ColumnWidth="1" Padding="2">
                                                                    <Triggers>
                                                                        <ext:FieldTrigger Icon="Clear" Qtip="清空" />
                                                                        <ext:FieldTrigger Icon="Search" Qtip="查找" />
                                                                    </Triggers>
