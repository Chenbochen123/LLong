<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanCompleteStat.aspx.cs" Inherits="Plugins_Curing_ProductPlan_PlanCompleteStat" %>
                                                ...
                                                <ext:FieldSet runat="server" Title="查询条件" Layout="ColumnLayout">
                                                    <Items>
                                                        <ext:Container runat="server" Layout="ColumnLayout" ColumnWidth="1">
                                                            <Items>
                                                                <ext:DateField runat="server" ID="dtSearchBeginDate" FieldLabel="开始日期" LabelAlign="Right" Format="yyyy-MM-dd" LabelWidth="100" InputWidth="150" ColumnWidth="0.5">
                                                                </ext:DateField>
                                                                <ext:DateField runat="server" ID="dtSearchEndDate" FieldLabel="结束日期" LabelAlign="Right" Format="yyyy-MM-dd" LabelWidth="100" InputWidth="150" ColumnWidth="0.5">
                                                                </ext:DateField>
                                                            </Items>
                                                        </ext:Container>
                                                        <ext:Container runat="server" Layout="ColumnLayout" ColumnWidth="1">
                            ...
                            <Items>
                                <ext:GridPanel runat="server" ID="gridPanelMain">
                                            ...
                                            <Model>
                                                <ext:Model runat="server" ID="gridPanelMainModel">
                                                    <Fields>
                                                        ...
                                                        <ext:ModelField Name="DIFF_AMOUNT" />
                                                        <ext:ModelField Name="COMPLETE_RATE" />
                                                    </Fields>
                                                </ext:Model>
                                            </Model>
                                        </ext:Store>
                                    ...
                                    <ColumnModel runat="server" ID="gridPanelMainColumnModel">
                                        <Columns>
                                            <ext:Column DataIndex="MATERIAL_NAME" Text="成品胎规格" />
                                            <ext:Column DataIndex="PLAN_AMOUNT" Text="计划数量" />
                                            <ext:Column DataIndex="REAL_AMOUNT" Text="实际数量" />
                                            <ext:Column DataIndex="DIFF_AMOUNT" Text="偏差量" />
                                            <ext:ComponentColumn DataIndex="COMPLETE_RATE" Text="完成率">
                                                <Component>
                                                    <ext:ProgressBar></ext:ProgressBar>
                                                </Component>
                                                <Listeners>
                                                    <Bind Handler="cmp.updateProgress(record.get('COMPLETE_RATE'), Ext.util.Format.number(record.get('COMPLETE_RATE') * 100, '0.00') + '%');" />
                                                </Listeners>
                                            </ext:ComponentColumn>
                                        </Columns>
                                    </ColumnModel>
