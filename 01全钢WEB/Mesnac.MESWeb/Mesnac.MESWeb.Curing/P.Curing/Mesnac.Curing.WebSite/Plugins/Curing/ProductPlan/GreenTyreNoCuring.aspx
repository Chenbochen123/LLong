<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GreenTyreNoCuring.aspx.cs" Inherits="Plugins_Curing_ProductPlan_GreenTyreNoCuring" %>
                        ...
                        <Items>
                            ...
                            <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                ...
                                <Items>
                                   ...
                                   <ext:ComboBox ID="cbxEquip" runat="server" FieldLabel="硫化机台" LabelAlign="Right" Editable="false" Hidden="true"></ext:ComboBox>
                                </Items>
                            </ext:Container>
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                Padding="5">
                                <Items>
                                    <ext:ComboBox ID="cbxShift" runat="server" FieldLabel="硫化班次" LabelAlign="Right" Editable="false" ></ext:ComboBox>
                                    <ext:ComboBox ID="cbxClass" runat="server" FieldLabel="硫化班组" LabelAlign="Right" Editable="false" Hidden="true"></ext:ComboBox>
                                </Items>
                            </ext:Container>
                        </Items>
                        <Listeners>
                        ...
                        <ext:GridPanel ID="pnlRatioList" runat="server">
                                    ...
                                    <Model>
                                        <ext:Model ID="model1" runat="server" IDProperty="OBJID">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="NO_CURING_COUNT" />
                                            </Fields>
                                        </ext:Model>
                                    </Model>
                                </ext:Store>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="TOTAL_COUNT" runat="server" Text="硫化数量" DataIndex="TOTAL_COUNT" Width="200" />
                                    <ext:Column ID="NO_CURING_COUNT" runat="server" Text="未推送数量" DataIndex="NO_CURING_COUNT" Width="200" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="EQUIP_NAME" runat="server" Text="硫化机台" DataIndex="EQUIP_NAME"  Flex="1" />
                                    ...
                                    <ext:Column ID="USER_NAME" runat="server" Text="操作工" DataIndex="USER_NAME" Flex="1" />
                                    <ext:DateColumn ID="BEGIN_TIME" runat="server" Text="生产时间" DataIndex="BEGIN_TIME" Flex="1" Format="yyyy-MM-dd HH:mm:ss"/>
                                </Columns>
                            </ColumnModel>
                          <%--  <SelectionModel>
