<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MouldBasicPattern.aspx.cs" Inherits="Plugins_Equip_Mould_MouldBasicPattern" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_editdefect = function (record) {
            ...
            var BrandName = record.data.PATTERN_NAME;
    ...
    <ext:Viewport ID="vpDefect" runat="server" Layout="border">
        <Items>
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true"
                        ...
                        <Items>
                             <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                      <ext:TextField ID="txbName" runat="server" FieldLabel="花纹名称" MaxLength="25"
                                        LabelAlign="Right" />
                                </Items>
                            </ext:Container>
                        </Items>
            ...
            <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5 "
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="PATTERN_NAME" runat="server" Text="花纹名称" DataIndex="PATTERN_NAME" Width="120" />
              ...
              <ext:Window ID="winAddDefect" runat="server" Icon="MonitorAdd" Closable="true" Title="添加花纹信息"
                            ...
                            <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                <Items>
                                    <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        Padding="5">
                                        <Items>
                                            <ext:TextField ID="txtAddBrandName" runat="server" FieldLabel="花纹名称" MaxLength="25"
            ...
            <ext:Window ID="winModifyDefect" runat="server" Icon="MonitorEdit" Closable="false"
                Title="修改花纹信息" Width="320" Height="250" Resizable="false" Hidden="true" Modal="false"
                                ...
                                <Items>
                                    <ext:Container ID="Container6" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        ...
                                        <Items>
                                            ...
                                            <ext:TextField ID="txtModifyBrandName" runat="server" FieldLabel="花纹名称" LabelAlign="Left"
