<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MouldBasicSize.aspx.cs" Inherits="Plugins_Equip_Mould_MouldBasicSize" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_editdefect = function (record) {
            ...
            var BrandName = record.data.SIZE_NAME;
    ...
    <ext:Viewport ID="vpDefect" runat="server" Layout="border">
        <Items>
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true"
                        ...
                        <Items>
                             <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                      <ext:TextField ID="txbName" runat="server" FieldLabel="规格名称" MaxLength="25"
                                        LabelAlign="Right" />
                                </Items>
                            </ext:Container>
                        </Items>
            ...
            <ext:Panel ID="Panel2" runat="server" Region="Center" Frame="true" Layout="Fit" MarginsSummary="0 5 0 5 "
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                <ext:RowNumbererColumn ID="rowNumCol1" runat="server" Width="35" />
                                 <ext:Column ID="SIZE_NAME" runat="server" Text="规格名称" DataIndex="SIZE_NAME" Width="120" />
              ...
              <ext:Window ID="winAddDefect" runat="server" Icon="MonitorAdd" Closable="true" Title="添加规格信息"
                            ...
                            <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                <Items>
                                    <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        Padding="5">
                                        <Items>
                                            <ext:TextField ID="txtAddBrandName" runat="server" FieldLabel="规格名称" MaxLength="25"
            ...
            <ext:Window ID="winModifyDefect" runat="server" Icon="MonitorEdit" Closable="false"
                Title="修改规格信息" Width="320" Height="250" Resizable="false" Hidden="true" Modal="false"
                                ...
                                <Items>
                                    <ext:Container ID="Container6" runat="server" Layout="FormLayout" ColumnWidth="1"
                                        ...
                                        <Items>
                                            ...
                                            <ext:TextField ID="txtModifyBrandName" runat="server" FieldLabel="规格名称" LabelAlign="Left"
