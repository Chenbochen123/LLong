<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SparePartOut.aspx.cs" Inherits="Plugins_Equip_Storage_SparePartOut" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            var userId = String(record.data.GET_USER_ID);
            var userName = String(record.data.USER_NAME);
            var amount = String(record.data.OUT_AMOUNT);
            var remark = String(record.data.REMARK);
            var outDate = String(record.data.OUT_DATE);
            SparePartOut.commandcolumn_direct_edit(ObjID, sparePartsName, sparePartsCode, sparePartsId, userId, userName, amount, outDate, remark,
        ...
        var commandcolumn_direct_recover = function (btn, record) {
            ...
            SparePartOut.commandcolumn_direct_recover(objID, {
                success: function (result) {
                },
        ...
        var commandcolumn_direct_delete = function (btn, record) {
            ...
            var ObjID = record.data.OBJID;
            SparePartOut.commandcolumn_direct_delete(ObjID, {
                success: function (result) {
...
<body>
    <form id="fmUnit" runat="server">
        ...
        <ext:ResourceManager ID="rmUnit" runat="server" DirectMethodNamespace="SparePartOut" />
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:DateField ID="txt_begin_receive_date" runat="server" FieldLabel="开始出库时间" LabelAlign="Right" Editable="false" />
                                        ...
                                        <ext:Container ID="container_3" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:DateField ID="txt_end_receive_date" runat="server" FieldLabel="结束出库时间" LabelAlign="Right" Editable="false" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:FormPanel>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center" Frame="true">
                     <Store>
                        <ext:Store ID="store" runat="server" PageSize="10">
                            <Proxy>
                                <ext:PageProxy DirectFn="SparePartOut.GridPanelBindData" />
                            </Proxy>
                            <Model>
                                <ext:Model ID="model" runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="GET_USER_ID" />
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:DateColumn Format="yyyy-MM-dd" ID="receive_date" runat="server" Text="出库日期" DataIndex="OUT_DATE" Width="120"  />
                            ...
                            <ext:Column ID="store_in_num" runat="server" Text="出库数量" DataIndex="OUT_AMOUNT" Width="60"  />
                            <ext:Column ID="delete_flag" runat="server" Text="删除标志" DataIndex="DELETE_FLAG" Width="80"  Hidden="true" />
                            <ext:Column ID="receive_user" runat="server" Text="领用人" DataIndex="USER_NAME" Width="100"  />
                                    ...
                                    <Items>
                                        <ext:Container ID="Container3" runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                               ...
                                               <%-- <ext:TextField ID="modify_sap_no" runat="server" FieldLabel="出库单号" LabelAlign="Left" ReadOnly="true"/>--%>
                                                <ext:DateField ID="modify_receive_date" runat="server" Type="Date" FieldLabel="出库日期" LabelAlign="Left" Editable="false"/>
                                        ...
                                        <ext:Container ID="Container4" runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                <ext:NumberField ID="modify_number" runat="server" FieldLabel="出库数量"  LabelAlign="Left"/>
                                                <ext:TriggerField ID="modify_receive_user" runat="server" FieldLabel="领用人" LabelAlign="Left" Editable="false"  AllowBlank="false">
                                                     <Triggers>
                                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                        <ext:FieldTrigger Icon="Search" />
                                                    </Triggers>
                                ...
                                <ext:Container ID="Container2" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                <ext:DateField ID="add_receive_date" runat="server" Type="Date" FieldLabel="出库日期" LabelAlign="Left" Editable="false"/>
                                        ...
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                <ext:NumberField ID="add_number" runat="server" FieldLabel="出库数量" LabelAlign="Left" AllowBlank="false"/>
                                                <ext:TriggerField ID="add_receive_user" runat="server" FieldLabel="领用人" LabelAlign="Left" Editable="false" AllowBlank="false" >
                                                     <Triggers>
                                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                        <ext:FieldTrigger Icon="Search" />
                                                    </Triggers>
