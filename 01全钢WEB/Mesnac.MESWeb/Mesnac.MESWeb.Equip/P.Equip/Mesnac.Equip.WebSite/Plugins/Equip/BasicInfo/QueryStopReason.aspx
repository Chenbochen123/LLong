<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryStopReason.aspx.cs" Inherits="Plugins_Equip_BasicInfo_QueryStopReason" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Plugins_Equip_BasicInfo_QueryStopReason_Request(record);
            parent.App.Plugins_Equip_BasicInfo_QueryStopReason_Window.close();
            return false;
        }
                                    ...
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                ...
                                                <ext:TextField ID="txtStopResons" runat="server" FieldLabel="停机原因" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="equip_name" DataIndex="MAJOR_TYPE_NAME" runat="server" Text="设备大类" Flex="1" />
                            <ext:Column ID="stop_type" DataIndex="EQUIP_STOP_REASON_NAME" runat="server" Text="停机原因" Flex="1" />
